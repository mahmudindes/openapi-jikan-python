...
class TestUserUpdatesDataAnimeInner(unittest.TestCase):
    """UserUpdatesDataAnimeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserUpdatesDataAnimeInner:
        """Test UserUpdatesDataAnimeInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserUpdatesDataAnimeInner`
        """
        model = UserUpdatesDataAnimeInner()
        if include_optional:
            return UserUpdatesDataAnimeInner(
    ...
    def testUserUpdatesDataAnimeInner(self):
        """Test UserUpdatesDataAnimeInner"""

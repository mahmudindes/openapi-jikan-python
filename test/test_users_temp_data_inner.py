...
class TestUsersTempDataInner(unittest.TestCase):
    """UsersTempDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInner:
        """Test UsersTempDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInner`
        """
        model = UsersTempDataInner()
        if include_optional:
            return UsersTempDataInner(
                mal_id = 56,
                username = '',
                url = '',
                images = jikan_openapi.models.users_temp_data_inner_images.users_temp_data_inner_images(
                    jpg = jikan_openapi.models.users_temp_data_inner_images_jpg.users_temp_data_inner_images_jpg(
                        image_url = '', ), 
                    webp = jikan_openapi.models.users_temp_data_inner_images_webp.users_temp_data_inner_images_webp(
                        image_url = '', ), ),
                last_online = '',
                gender = '',
                birthday = '',
                location = '',
                joined = '',
                anime_stats = jikan_openapi.models.users_temp_data_inner_anime_stats.users_temp_data_inner_anime_stats(
                    days_watched = 1.337, 
                    mean_score = 1.337, 
                    watching = 56, 
                    completed = 56, 
                    ...
                    rewatched = 56, 
                    episodes_watched = 56, ),
                manga_stats = jikan_openapi.models.users_temp_data_inner_manga_stats.users_temp_data_inner_manga_stats(
                    days_read = 1.337, 
                    mean_score = 1.337, 
                    reading = 56, 
                    completed = 56, 
                    ...
                    chapters_read = 56, 
                    volumes_read = 56, ),
                favorites = jikan_openapi.models.users_temp_data_inner_favorites.users_temp_data_inner_favorites(
                    anime = [
                        jikan_openapi.models.entry_meta.entry_meta(
                            mal_id = 56, 
                            url = '', 
                            image_url = '', 
                            name = '', )
    ...
    def testUsersTempDataInner(self):
        """Test UsersTempDataInner"""

...
class TestCharacterMeta(unittest.TestCase):
    """CharacterMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterMeta:
        """Test CharacterMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterMeta`
        """
        model = CharacterMeta()
        if include_optional:

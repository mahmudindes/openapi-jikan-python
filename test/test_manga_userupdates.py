...
class TestMangaUserupdates(unittest.TestCase):
    """MangaUserupdates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaUserupdates:
        """Test MangaUserupdates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaUserupdates`
        """
        model = MangaUserupdates()
        if include_optional:
            return MangaUserupdates(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.manga_userupdates_all_of_data.manga_userupdates_allOf_data(

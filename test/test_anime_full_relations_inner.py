...
class TestAnimeFullRelationsInner(unittest.TestCase):
    """AnimeFullRelationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeFullRelationsInner:
        """Test AnimeFullRelationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeFullRelationsInner`
        """
        model = AnimeFullRelationsInner()
        if include_optional:
            return AnimeFullRelationsInner(
                relation = '',
                entry = [
    ...
    def testAnimeFullRelationsInner(self):
        """Test AnimeFullRelationsInner"""

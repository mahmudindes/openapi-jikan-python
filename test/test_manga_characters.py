...
class TestMangaCharacters(unittest.TestCase):
    """MangaCharacters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaCharacters:
        """Test MangaCharacters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaCharacters`
        """
        model = MangaCharacters()
        if include_optional:
            return MangaCharacters(
                data = [
                    jikan_openapi.models.manga_characters_data_inner.manga_characters_data_inner(

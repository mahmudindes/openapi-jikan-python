...
class TestUserFriendsAllOfData(unittest.TestCase):
    """UserFriendsAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserFriendsAllOfData:
        """Test UserFriendsAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFriendsAllOfData`
        """
        model = UserFriendsAllOfData()
        if include_optional:
            return UserFriendsAllOfData(
    ...
    def testUserFriendsAllOfData(self):
        """Test UserFriendsAllOfData"""

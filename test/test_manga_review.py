...
class TestMangaReview(unittest.TestCase):
    """MangaReview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaReview:
        """Test MangaReview
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaReview`
        """
        model = MangaReview()
        if include_optional:
            return MangaReview(

...
class TestCharacterPictures(unittest.TestCase):
    """CharacterPictures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterPictures:
        """Test CharacterPictures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterPictures`
        """
        model = CharacterPictures()
        if include_optional:
            return CharacterPictures(
                data = [
                    jikan_openapi.models.character_pictures_data_inner.character_pictures_data_inner(
                        image_url = '', 
                        large_image_url = '', )
                    ]
            )
    ...
    def testCharacterPictures(self):
        """Test CharacterPictures"""

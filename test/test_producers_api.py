...
class TestProducersApi(unittest.TestCase):
    """ProducersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProducersApi()

    def tearDown(self) -> None:
        pass

    def test_get_producer_by_id(self) -> None:
        """Test case for get_producer_by_id

        """
        pass

    def test_get_producer_external(self) -> None:
        """Test case for get_producer_external

        """
        pass

    def test_get_producer_full_by_id(self) -> None:
        """Test case for get_producer_full_by_id

        """
        pass

    def test_get_producers(self) -> None:
        """Test case for get_producers

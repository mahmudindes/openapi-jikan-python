...
class TestPersonPictures(unittest.TestCase):
    """PersonPictures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPictures:
        """Test PersonPictures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPictures`
        """
        model = PersonPictures()
        if include_optional:
            return PersonPictures(
                data = [
                    jikan_openapi.models.people_images.people_images(

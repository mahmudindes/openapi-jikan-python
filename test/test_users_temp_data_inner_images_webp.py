...
class TestUsersTempDataInnerImagesWebp(unittest.TestCase):
    """UsersTempDataInnerImagesWebp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInnerImagesWebp:
        """Test UsersTempDataInnerImagesWebp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInnerImagesWebp`
        """
        model = UsersTempDataInnerImagesWebp()
        if include_optional:
            return UsersTempDataInnerImagesWebp(
                image_url = ''
            )
        else:
            return UsersTempDataInnerImagesWebp(
    ...
    def testUsersTempDataInnerImagesWebp(self):
        """Test UsersTempDataInnerImagesWebp"""

...
class TestGetAnimeEpisodeById200Response(unittest.TestCase):
    """GetAnimeEpisodeById200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnimeEpisodeById200Response:
        """Test GetAnimeEpisodeById200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnimeEpisodeById200Response`
        """
        model = GetAnimeEpisodeById200Response()
        if include_optional:
            return GetAnimeEpisodeById200Response(
                data = jikan_openapi.models.anime_episode.anime_episode(
                    mal_id = 56, 
                    url = '', 
                    title = '', 
                    title_japanese = '', 
    ...
    def testGetAnimeEpisodeById200Response(self):
        """Test GetAnimeEpisodeById200Response"""

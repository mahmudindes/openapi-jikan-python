...
class TestAnimeStatistics(unittest.TestCase):
    """AnimeStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStatistics:
        """Test AnimeStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStatistics`
        """
        model = AnimeStatistics()
        if include_optional:
            return AnimeStatistics(
                data = jikan_openapi.models.anime_statistics_data.anime_statistics_data(
                    watching = 56, 
                    completed = 56, 
                    on_hold = 56, 
                    dropped = 56, 

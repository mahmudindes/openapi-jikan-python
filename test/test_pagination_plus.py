...
class TestPaginationPlus(unittest.TestCase):
    """PaginationPlus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationPlus:
        """Test PaginationPlus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationPlus`
        """
        model = PaginationPlus()
        if include_optional:

...
class TestUserFriends(unittest.TestCase):
    """UserFriends unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserFriends:
        """Test UserFriends
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFriends`
        """
        model = UserFriends()
        if include_optional:
            return UserFriends(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.user_friends_all_of_data.user_friends_allOf_data()
                    ]
            )
        else:
            return UserFriends(

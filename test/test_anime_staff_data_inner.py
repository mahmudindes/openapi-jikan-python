...
class TestAnimeStaffDataInner(unittest.TestCase):
    """AnimeStaffDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStaffDataInner:
        """Test AnimeStaffDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStaffDataInner`
        """
        model = AnimeStaffDataInner()
        if include_optional:
            return AnimeStaffDataInner(
                person = jikan_openapi.models.anime_staff_data_inner_person.anime_staff_data_inner_person(
                    mal_id = 56, 
                    url = '', 
    ...
    def testAnimeStaffDataInner(self):
        """Test AnimeStaffDataInner"""

...
class TestWatchEpisodes(unittest.TestCase):
    """WatchEpisodes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchEpisodes:
        """Test WatchEpisodes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchEpisodes`
        """
        model = WatchEpisodes()
        if include_optional:
            return WatchEpisodes(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.watch_episodes_all_of_data.watch_episodes_allOf_data(

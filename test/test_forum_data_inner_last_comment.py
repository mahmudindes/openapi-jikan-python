...
class TestForumDataInnerLastComment(unittest.TestCase):
    """ForumDataInnerLastComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForumDataInnerLastComment:
        """Test ForumDataInnerLastComment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForumDataInnerLastComment`
        """
        model = ForumDataInnerLastComment()
        if include_optional:
            return ForumDataInnerLastComment(
                url = '',
                author_username = '',
                author_url = '',
                var_date = ''
    ...
    def testForumDataInnerLastComment(self):
        """Test ForumDataInnerLastComment"""

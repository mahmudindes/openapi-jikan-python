...
class TestPeopleSearchAllOfData(unittest.TestCase):
    """PeopleSearchAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeopleSearchAllOfData:
        """Test PeopleSearchAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeopleSearchAllOfData`
        """
        model = PeopleSearchAllOfData()
        if include_optional:
            return PeopleSearchAllOfData(
                mal_id = 56,
                url = '',
                website_url = '',
    ...
    def testPeopleSearchAllOfData(self):
        """Test PeopleSearchAllOfData"""

...
class TestCharacterFullMangaInner(unittest.TestCase):
    """CharacterFullMangaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterFullMangaInner:
        """Test CharacterFullMangaInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterFullMangaInner`
        """
        model = CharacterFullMangaInner()
        if include_optional:
            return CharacterFullMangaInner(
                role = '',
    ...
    def testCharacterFullMangaInner(self):
        """Test CharacterFullMangaInner"""

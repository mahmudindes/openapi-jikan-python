...
class TestClubSearchQueryOrderby(unittest.TestCase):
    """ClubSearchQueryOrderby unit test stubs"""
    ...
    def testClubSearchQueryOrderby(self):
        """Test ClubSearchQueryOrderby"""
        # inst = ClubSearchQueryOrderby()

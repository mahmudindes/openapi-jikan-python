...
class TestMangaSearch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MangaSearch:
        """Test MangaSearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaSearch`
        """
        model = MangaSearch()
        if include_optional:
            return MangaSearch(
                pagination = jikan_openapi.models.pagination_plus_pagination.pagination_plus_pagination(
                    ...
                    items = jikan_openapi.models.pagination_plus_pagination_items.pagination_plus_pagination_items(
                        ...
                        per_page = 56, ), ),
                data = [
                    jikan_openapi.models.manga.manga(
                        mal_id = 56, 
                        url = '', 

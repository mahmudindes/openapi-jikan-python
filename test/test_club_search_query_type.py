...
class TestClubSearchQueryType(unittest.TestCase):
    """ClubSearchQueryType unit test stubs"""
    ...
    def testClubSearchQueryType(self):
        """Test ClubSearchQueryType"""
        # inst = ClubSearchQueryType()

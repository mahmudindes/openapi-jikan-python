...
class TestAnimeEpisodes(unittest.TestCase):
    """AnimeEpisodes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeEpisodes:
        """Test AnimeEpisodes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeEpisodes`
        """
        model = AnimeEpisodes()
        if include_optional:
            return AnimeEpisodes(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.anime_episodes_all_of_data.anime_episodes_allOf_data(
                        mal_id = 56, 
                        url = '', 
                        title = '', 
                        title_japanese = '', 

...
class TestClubRelations(unittest.TestCase):
    """ClubRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubRelations:
        """Test ClubRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubRelations`
        """
        model = ClubRelations()
        if include_optional:
            return ClubRelations(
                data = jikan_openapi.models.club_relations_data.club_relations_data(
                    anime = [

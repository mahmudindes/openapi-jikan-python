...
class TestPaginationPlusPagination(unittest.TestCase):
    """PaginationPlusPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationPlusPagination:
        """Test PaginationPlusPagination
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationPlusPagination`
        """
        model = PaginationPlusPagination()
        if include_optional:
    ...
    def testPaginationPlusPagination(self):
        """Test PaginationPlusPagination"""

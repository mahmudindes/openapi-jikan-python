...
class TestUsersTempDataInnerMangaStats(unittest.TestCase):
    """UsersTempDataInnerMangaStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInnerMangaStats:
        """Test UsersTempDataInnerMangaStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInnerMangaStats`
        """
        model = UsersTempDataInnerMangaStats()
        if include_optional:
            return UsersTempDataInnerMangaStats(
                days_read = 1.337,
                mean_score = 1.337,
                reading = 56,
                completed = 56,
    ...
    def testUsersTempDataInnerMangaStats(self):
        """Test UsersTempDataInnerMangaStats"""

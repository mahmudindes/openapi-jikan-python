...
class TestMagazines(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Magazines:
        """Test Magazines
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Magazines`
        """
        model = Magazines()
        if include_optional:
            return Magazines(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.magazine.magazine(
                        mal_id = 56, 
                        name = '', 
                        url = '', 
                        count = 56, )

...
class TestAnimeMeta(unittest.TestCase):
    """AnimeMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeMeta:
        """Test AnimeMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeMeta`
        """
        model = AnimeMeta()
        if include_optional:
            return AnimeMeta(

...
class TestUserClubsAllOfData(unittest.TestCase):
    """UserClubsAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserClubsAllOfData:
        """Test UserClubsAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserClubsAllOfData`
        """
        model = UserClubsAllOfData()
        if include_optional:
            return UserClubsAllOfData(
                mal_id = 56,
                name = '',
                url = ''
            )
    ...
    def testUserClubsAllOfData(self):
        """Test UserClubsAllOfData"""

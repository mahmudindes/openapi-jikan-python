...
class TestAnimeEpisodesAllOfData(unittest.TestCase):
    """AnimeEpisodesAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeEpisodesAllOfData:
        """Test AnimeEpisodesAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeEpisodesAllOfData`
        """
        model = AnimeEpisodesAllOfData()
        if include_optional:
            return AnimeEpisodesAllOfData(
                mal_id = 56,
                url = '',
                title = '',
                title_japanese = '',
    ...
    def testAnimeEpisodesAllOfData(self):
        """Test AnimeEpisodesAllOfData"""

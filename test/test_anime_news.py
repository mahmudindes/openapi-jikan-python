...
class TestAnimeNews(unittest.TestCase):
    """AnimeNews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeNews:
        """Test AnimeNews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeNews`
        """
        model = AnimeNews()
        if include_optional:
            return AnimeNews(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.news_data_inner.news_data_inner(
                        mal_id = 56, 
                        url = '', 
                        title = '', 
                        date = '', 

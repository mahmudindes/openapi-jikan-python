...
class TestClubStaff(unittest.TestCase):
    """ClubStaff unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubStaff:
        """Test ClubStaff
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubStaff`
        """
        model = ClubStaff()
        if include_optional:
            return ClubStaff(
                data = [
                    jikan_openapi.models.club_staff_data_inner.club_staff_data_inner(
                        url = '', 
                        username = '', )
                    ]
            )

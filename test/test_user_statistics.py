...
class TestUserStatistics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserStatistics:
        """Test UserStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserStatistics`
        """
        model = UserStatistics()
        if include_optional:
            return UserStatistics(
                data = jikan_openapi.models.user_profile_full_statistics.user_profile_full_statistics(

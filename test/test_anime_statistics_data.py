...
class TestAnimeStatisticsData(unittest.TestCase):
    """AnimeStatisticsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStatisticsData:
        """Test AnimeStatisticsData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStatisticsData`
        """
        model = AnimeStatisticsData()
        if include_optional:
    ...
    def testAnimeStatisticsData(self):
        """Test AnimeStatisticsData"""

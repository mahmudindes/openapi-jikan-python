...
class TestUserImagesWebp(unittest.TestCase):
    """UserImagesWebp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserImagesWebp:
        """Test UserImagesWebp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserImagesWebp`
        """
        model = UserImagesWebp()
        if include_optional:

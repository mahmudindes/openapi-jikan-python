...
class TestUsersSearchQueryGender(unittest.TestCase):
    """UsersSearchQueryGender unit test stubs"""
    ...
    def testUsersSearchQueryGender(self):
        """Test UsersSearchQueryGender"""
        # inst = UsersSearchQueryGender()

...
class TestPersonManga(unittest.TestCase):
    """PersonManga unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonManga:
        """Test PersonManga
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonManga`
        """
        model = PersonManga()
        if include_optional:
            return PersonManga(

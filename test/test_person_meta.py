...
class TestPersonMeta(unittest.TestCase):
    """PersonMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonMeta:
        """Test PersonMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonMeta`
        """
        model = PersonMeta()
        if include_optional:
            return PersonMeta(

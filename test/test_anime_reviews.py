...
class TestAnimeReviews(unittest.TestCase):
    """AnimeReviews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeReviews:
        """Test AnimeReviews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeReviews`
        """
        model = AnimeReviews()
        if include_optional:
            return AnimeReviews(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.anime_reviews_all_of_data.anime_reviews_allOf_data()
                    ]
            )
        else:
            return AnimeReviews(

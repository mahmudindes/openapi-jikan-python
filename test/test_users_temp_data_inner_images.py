...
class TestUsersTempDataInnerImages(unittest.TestCase):
    """UsersTempDataInnerImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInnerImages:
        """Test UsersTempDataInnerImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInnerImages`
        """
        model = UsersTempDataInnerImages()
        if include_optional:
            return UsersTempDataInnerImages(
    ...
    def testUsersTempDataInnerImages(self):
        """Test UsersTempDataInnerImages"""

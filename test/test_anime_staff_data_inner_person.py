...
class TestAnimeStaffDataInnerPerson(unittest.TestCase):
    """AnimeStaffDataInnerPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStaffDataInnerPerson:
        """Test AnimeStaffDataInnerPerson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStaffDataInnerPerson`
        """
        model = AnimeStaffDataInnerPerson()
        if include_optional:
            return AnimeStaffDataInnerPerson(
                mal_id = 56,
                url = '',
    ...
    def testAnimeStaffDataInnerPerson(self):
        """Test AnimeStaffDataInnerPerson"""

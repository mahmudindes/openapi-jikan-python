...
class TestPersonFull(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonFull:
        """Test PersonFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonFull`
        """
        model = PersonFull()
        if include_optional:
            return PersonFull(

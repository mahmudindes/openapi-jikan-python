...
class TestUserAboutDataInner(unittest.TestCase):
    """UserAboutDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserAboutDataInner:
        """Test UserAboutDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserAboutDataInner`
        """
        model = UserAboutDataInner()
        if include_optional:
            return UserAboutDataInner(
                about = ''
            )
        else:
            return UserAboutDataInner(
    ...
    def testUserAboutDataInner(self):
        """Test UserAboutDataInner"""

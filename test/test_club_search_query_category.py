...
class TestClubSearchQueryCategory(unittest.TestCase):
    """ClubSearchQueryCategory unit test stubs"""
    ...
    def testClubSearchQueryCategory(self):
        """Test ClubSearchQueryCategory"""
        # inst = ClubSearchQueryCategory()

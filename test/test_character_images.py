...
class TestCharacterImages(unittest.TestCase):
    """CharacterImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterImages:
        """Test CharacterImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterImages`
        """

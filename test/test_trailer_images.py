...
class TestTrailerImages(unittest.TestCase):
    """TrailerImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrailerImages:
        """Test TrailerImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrailerImages`
        """
        model = TrailerImages()
        if include_optional:
            return TrailerImages(
                images = jikan_openapi.models.trailer_images_images.trailer_images_images(
                    image_url = '', 
                    small_image_url = '', 
                    medium_image_url = '', 
                    large_image_url = '', 

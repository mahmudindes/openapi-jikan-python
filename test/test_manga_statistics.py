...
class TestMangaStatistics(unittest.TestCase):
    """MangaStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaStatistics:
        """Test MangaStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaStatistics`
        """
        model = MangaStatistics()
        if include_optional:
            return MangaStatistics(
                data = jikan_openapi.models.manga_statistics_data.manga_statistics_data(
                    reading = 56, 
                    completed = 56, 
                    on_hold = 56, 
                    dropped = 56, 
                    ...
                    total = 56, 
                    scores = [
                        jikan_openapi.models.anime_statistics_data_scores_inner.anime_statistics_data_scores_inner(
                            score = 56, 
                            votes = 56, 
                            percentage = 1.337, )
                        ], )

...
class TestGetPersonFullById200Response(unittest.TestCase):
    """GetPersonFullById200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPersonFullById200Response:
        """Test GetPersonFullById200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPersonFullById200Response`
        """
        model = GetPersonFullById200Response()
        if include_optional:
            return GetPersonFullById200Response(
                data = jikan_openapi.models.person_full.person_full(
                    mal_id = 56, 
                    url = '', 
                    website_url = '', 
                    ...
                    about = '', 
                    anime = [
                        jikan_openapi.models.person_anime_data_inner.person_anime_data_inner(
                            position = '', )
                        ], 
                    manga = [
                        jikan_openapi.models.person_full_manga_inner.person_full_manga_inner(
                            position = '', )
                        ], 
                    voices = [
                        jikan_openapi.models.person_full_voices_inner.person_full_voices_inner(
                            role = '', 
                            character = jikan_openapi.models.character_meta.character_meta(
                                mal_id = 56, 
                                url = '', 
                                name = '', ), )
                        ], )
    ...
    def testGetPersonFullById200Response(self):
        """Test GetPersonFullById200Response"""

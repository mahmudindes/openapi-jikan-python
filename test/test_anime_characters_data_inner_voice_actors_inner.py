...
class TestAnimeCharactersDataInnerVoiceActorsInner(unittest.TestCase):
    """AnimeCharactersDataInnerVoiceActorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeCharactersDataInnerVoiceActorsInner:
        """Test AnimeCharactersDataInnerVoiceActorsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeCharactersDataInnerVoiceActorsInner`
        """
        model = AnimeCharactersDataInnerVoiceActorsInner()
        if include_optional:
            return AnimeCharactersDataInnerVoiceActorsInner(
    ...
    def testAnimeCharactersDataInnerVoiceActorsInner(self):
        """Test AnimeCharactersDataInnerVoiceActorsInner"""

...
class TestAnimeReviewsAllOfData(unittest.TestCase):
    """AnimeReviewsAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeReviewsAllOfData:
        """Test AnimeReviewsAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeReviewsAllOfData`
        """
        model = AnimeReviewsAllOfData()
        if include_optional:
            return AnimeReviewsAllOfData(
                mal_id = 56,
                url = '',
                type = '',
    ...
    def testAnimeReviewsAllOfData(self):
        """Test AnimeReviewsAllOfData"""

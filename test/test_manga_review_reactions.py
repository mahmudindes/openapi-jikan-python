...
class TestMangaReviewReactions(unittest.TestCase):
    """MangaReviewReactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaReviewReactions:
        """Test MangaReviewReactions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaReviewReactions`
        """
        model = MangaReviewReactions()
        if include_optional:
    ...
    def testMangaReviewReactions(self):
        """Test MangaReviewReactions"""

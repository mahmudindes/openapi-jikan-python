...
class TestMagazinesQueryOrderby(unittest.TestCase):
    """MagazinesQueryOrderby unit test stubs"""
    ...
    def testMagazinesQueryOrderby(self):
        """Test MagazinesQueryOrderby"""
        # inst = MagazinesQueryOrderby()

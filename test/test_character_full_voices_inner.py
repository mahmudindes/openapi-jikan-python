...
class TestCharacterFullVoicesInner(unittest.TestCase):
    """CharacterFullVoicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterFullVoicesInner:
        """Test CharacterFullVoicesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterFullVoicesInner`
        """
        model = CharacterFullVoicesInner()
        if include_optional:
            return CharacterFullVoicesInner(
                language = '',
    ...
    def testCharacterFullVoicesInner(self):
        """Test CharacterFullVoicesInner"""

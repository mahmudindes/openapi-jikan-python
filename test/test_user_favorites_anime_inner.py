...
class TestUserFavoritesAnimeInner(unittest.TestCase):
    """UserFavoritesAnimeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserFavoritesAnimeInner:
        """Test UserFavoritesAnimeInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFavoritesAnimeInner`
        """
        model = UserFavoritesAnimeInner()
        if include_optional:
            return UserFavoritesAnimeInner(
                mal_id = 56,
                url = '',
    ...
    def testUserFavoritesAnimeInner(self):
        """Test UserFavoritesAnimeInner"""

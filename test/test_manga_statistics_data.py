...
class TestMangaStatisticsData(unittest.TestCase):
    """MangaStatisticsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaStatisticsData:
        """Test MangaStatisticsData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaStatisticsData`
        """
        model = MangaStatisticsData()
        if include_optional:
    ...
    def testMangaStatisticsData(self):
        """Test MangaStatisticsData"""

...
class TestAnimeVideosData(unittest.TestCase):
    """AnimeVideosData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosData:
        """Test AnimeVideosData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosData`
        """
        model = AnimeVideosData()
        if include_optional:

...
class TestForumDataInner(unittest.TestCase):
    """ForumDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForumDataInner:
        """Test ForumDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForumDataInner`
        """
        model = ForumDataInner()
        if include_optional:
            return ForumDataInner(
                mal_id = 56,
                url = '',
                title = '',
                var_date = '',
                ...
                author_url = '',
                comments = 56,
                last_comment = jikan_openapi.models.forum_data_inner_last_comment.forum_data_inner_last_comment(
                    url = '', 
                    author_username = '', 
                    author_url = '', 
                    date = '', )

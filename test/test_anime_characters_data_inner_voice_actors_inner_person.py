...
class TestAnimeCharactersDataInnerVoiceActorsInnerPerson(unittest.TestCase):
    """AnimeCharactersDataInnerVoiceActorsInnerPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeCharactersDataInnerVoiceActorsInnerPerson:
        """Test AnimeCharactersDataInnerVoiceActorsInnerPerson
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeCharactersDataInnerVoiceActorsInnerPerson`
        """
        model = AnimeCharactersDataInnerVoiceActorsInnerPerson()
        if include_optional:
            return AnimeCharactersDataInnerVoiceActorsInnerPerson(
                mal_id = 56,
                url = '',
    ...
    def testAnimeCharactersDataInnerVoiceActorsInnerPerson(self):
        """Test AnimeCharactersDataInnerVoiceActorsInnerPerson"""

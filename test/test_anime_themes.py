...
class TestAnimeThemes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnimeThemes:
        """Test AnimeThemes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeThemes`
        """
        model = AnimeThemes()
        if include_optional:
            return AnimeThemes(
                data = jikan_openapi.models.anime_full_theme.anime_full_theme(
                    openings = [
                        ''
                        ], 
                    endings = [

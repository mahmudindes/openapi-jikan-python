...
class TestAnimeCharactersDataInner(unittest.TestCase):
    """AnimeCharactersDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeCharactersDataInner:
        """Test AnimeCharactersDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeCharactersDataInner`
        """
        model = AnimeCharactersDataInner()
        if include_optional:
            return AnimeCharactersDataInner(
                character = jikan_openapi.models.anime_characters_data_inner_character.anime_characters_data_inner_character(
                    mal_id = 56, 
                    url = '', 
                    images = jikan_openapi.models.character_images.character_images(
                        jpg = jikan_openapi.models.character_images_jpg.character_images_jpg(
                            image_url = '', 
                            small_image_url = '', ), 
                        webp = jikan_openapi.models.character_images_webp.character_images_webp(
                            image_url = '', 
                            small_image_url = '', ), ), 
                    name = '', ),
                role = '',
                voice_actors = [
                    jikan_openapi.models.anime_characters_data_inner_voice_actors_inner.anime_characters_data_inner_voice_actors_inner(
                        person = jikan_openapi.models.anime_characters_data_inner_voice_actors_inner_person.anime_characters_data_inner_voice_actors_inner_person(
                            mal_id = 56, 
                            url = '', 
                            images = jikan_openapi.models.people_images.people_images(
                                jpg = jikan_openapi.models.user_images_jpg.user_images_jpg(
                                    image_url = '', ), ), 
                            name = '', ), 
                        language = '', )
                    ]
    ...
    def testAnimeCharactersDataInner(self):
        """Test AnimeCharactersDataInner"""

...
class TestUserFavorites(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserFavorites:
        """Test UserFavorites
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFavorites`
        """
        model = UserFavorites()
        if include_optional:
            return UserFavorites(
                anime = [
                    jikan_openapi.models.user_favorites_anime_inner.user_favorites_anime_inner()
                    ],
                manga = [
                    jikan_openapi.models.user_favorites_manga_inner.user_favorites_manga_inner()
                    ],
                characters = [
                    jikan_openapi.models.user_favorites_characters_inner.user_favorites_characters_inner()
                    ],
                people = [
                    jikan_openapi.models.character_meta.character_meta(
                        mal_id = 56, 
                        url = '', 

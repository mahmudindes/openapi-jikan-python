...
class TestTopReviewsTypeEnum(unittest.TestCase):
    """TopReviewsTypeEnum unit test stubs"""
    ...
    def testTopReviewsTypeEnum(self):
        """Test TopReviewsTypeEnum"""
        # inst = TopReviewsTypeEnum()

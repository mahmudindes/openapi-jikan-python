...
class TestAnimeImagesJpg(unittest.TestCase):
    """AnimeImagesJpg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeImagesJpg:
        """Test AnimeImagesJpg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeImagesJpg`
        """
        model = AnimeImagesJpg()
        if include_optional:

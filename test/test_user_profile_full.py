...
class TestUserProfileFull(unittest.TestCase):
    """UserProfileFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserProfileFull:
        """Test UserProfileFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserProfileFull`
        """
        model = UserProfileFull()
        if include_optional:

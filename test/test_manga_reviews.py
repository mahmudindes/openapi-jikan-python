...
class TestMangaReviews(unittest.TestCase):
    """MangaReviews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaReviews:
        """Test MangaReviews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaReviews`
        """
        model = MangaReviews()
        if include_optional:
            return MangaReviews(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.manga_reviews_all_of_data.manga_reviews_allOf_data()
                    ]
            )
        else:
            return MangaReviews(

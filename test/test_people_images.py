...
class TestPeopleImages(unittest.TestCase):
    """PeopleImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeopleImages:
        """Test PeopleImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeopleImages`
        """
        model = PeopleImages()
        if include_optional:
            return PeopleImages(

...
class TestUsersSearchAllOfData(unittest.TestCase):
    """UsersSearchAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersSearchAllOfData:
        """Test UsersSearchAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersSearchAllOfData`
        """
        model = UsersSearchAllOfData()
        if include_optional:
            return UsersSearchAllOfData(
                url = '',
                username = '',
    ...
    def testUsersSearchAllOfData(self):
        """Test UsersSearchAllOfData"""

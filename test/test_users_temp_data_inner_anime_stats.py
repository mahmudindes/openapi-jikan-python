...
class TestUsersTempDataInnerAnimeStats(unittest.TestCase):
    """UsersTempDataInnerAnimeStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInnerAnimeStats:
        """Test UsersTempDataInnerAnimeStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInnerAnimeStats`
        """
        model = UsersTempDataInnerAnimeStats()
        if include_optional:
            return UsersTempDataInnerAnimeStats(
                days_watched = 1.337,
                mean_score = 1.337,
                watching = 56,
                completed = 56,
    ...
    def testUsersTempDataInnerAnimeStats(self):
        """Test UsersTempDataInnerAnimeStats"""

...
class TestWatchPromos(unittest.TestCase):
    """WatchPromos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchPromos:
        """Test WatchPromos
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchPromos`
        """
        model = WatchPromos()
        if include_optional:
            return WatchPromos(

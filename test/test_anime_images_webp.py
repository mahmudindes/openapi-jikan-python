...
class TestAnimeImagesWebp(unittest.TestCase):
    """AnimeImagesWebp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeImagesWebp:
        """Test AnimeImagesWebp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeImagesWebp`
        """
        model = AnimeImagesWebp()
        if include_optional:

...
class TestProducers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Producers:
        """Test Producers
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Producers`
        """
        model = Producers()
        if include_optional:
            return Producers(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.producer.producer(
                        mal_id = 56, 
                        url = '', 
                        titles = [

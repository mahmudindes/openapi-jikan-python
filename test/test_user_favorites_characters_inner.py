...
class TestUserFavoritesCharactersInner(unittest.TestCase):
    """UserFavoritesCharactersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserFavoritesCharactersInner:
        """Test UserFavoritesCharactersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFavoritesCharactersInner`
        """
        model = UserFavoritesCharactersInner()
        if include_optional:
            return UserFavoritesCharactersInner(
                mal_id = 56,
                url = '',
    ...
    def testUserFavoritesCharactersInner(self):
        """Test UserFavoritesCharactersInner"""

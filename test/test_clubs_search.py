...
class TestClubsSearch(unittest.TestCase):
    """ClubsSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubsSearch:
        """Test ClubsSearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubsSearch`
        """
        model = ClubsSearch()
        if include_optional:
            return ClubsSearch(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.club.club(
                        mal_id = 56, 
                        name = '', 
                        url = '', 

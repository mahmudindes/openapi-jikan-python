...
class TestPersonVoiceActingRoles(unittest.TestCase):
    """PersonVoiceActingRoles unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonVoiceActingRoles:
        """Test PersonVoiceActingRoles
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonVoiceActingRoles`
        """
        model = PersonVoiceActingRoles()
        if include_optional:
    ...
    def testPersonVoiceActingRoles(self):
        """Test PersonVoiceActingRoles"""

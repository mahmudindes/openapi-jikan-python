...
class TestPersonAnime(unittest.TestCase):
    """PersonAnime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonAnime:
        """Test PersonAnime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonAnime`
        """
        model = PersonAnime()
        if include_optional:
            return PersonAnime(

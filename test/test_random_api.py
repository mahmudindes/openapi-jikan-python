...
class TestRandomApi(unittest.TestCase):
    ...
    def test_get_random_anime(self) -> None:
        """Test case for get_random_anime

        """
        pass

    def test_get_random_characters(self) -> None:
        """Test case for get_random_characters

        """
        pass

    def test_get_random_manga(self) -> None:
        """Test case for get_random_manga

        """
        pass

    def test_get_random_people(self) -> None:
        """Test case for get_random_people

        """
        pass

    def test_get_random_users(self) -> None:
        """Test case for get_random_users

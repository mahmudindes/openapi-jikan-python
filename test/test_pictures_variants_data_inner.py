...
class TestPicturesVariantsDataInner(unittest.TestCase):
    """PicturesVariantsDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PicturesVariantsDataInner:
        """Test PicturesVariantsDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PicturesVariantsDataInner`
        """
        model = PicturesVariantsDataInner()
        if include_optional:
            return PicturesVariantsDataInner(
    ...
    def testPicturesVariantsDataInner(self):
        """Test PicturesVariantsDataInner"""

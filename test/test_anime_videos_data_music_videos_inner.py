...
class TestAnimeVideosDataMusicVideosInner(unittest.TestCase):
    """AnimeVideosDataMusicVideosInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosDataMusicVideosInner:
        """Test AnimeVideosDataMusicVideosInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosDataMusicVideosInner`
        """
        model = AnimeVideosDataMusicVideosInner()
        if include_optional:
            return AnimeVideosDataMusicVideosInner(
                title = '',
    ...
    def testAnimeVideosDataMusicVideosInner(self):
        """Test AnimeVideosDataMusicVideosInner"""

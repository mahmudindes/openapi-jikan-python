...
class TestClubRelationsData(unittest.TestCase):
    """ClubRelationsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubRelationsData:
        """Test ClubRelationsData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubRelationsData`
        """
        model = ClubRelationsData()
        if include_optional:
    ...
    def testClubRelationsData(self):
        """Test ClubRelationsData"""

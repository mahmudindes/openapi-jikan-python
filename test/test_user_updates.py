...
class TestUserUpdates(unittest.TestCase):
    """UserUpdates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserUpdates:
        """Test UserUpdates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserUpdates`
        """
        model = UserUpdates()
        if include_optional:
            return UserUpdates(
                data = jikan_openapi.models.user_updates_data.user_updates_data(
                    anime = [
                        jikan_openapi.models.user_updates_data_anime_inner.user_updates_data_anime_inner()
                        ], 
                    manga = [
                        jikan_openapi.models.user_updates_data_manga_inner.user_updates_data_manga_inner()
                        ], )
            )
        else:
            return UserUpdates(

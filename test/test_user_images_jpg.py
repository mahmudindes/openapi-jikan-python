...
class TestUserImagesJpg(unittest.TestCase):
    """UserImagesJpg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserImagesJpg:
        """Test UserImagesJpg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserImagesJpg`
        """
        model = UserImagesJpg()
        if include_optional:

...
class TestWatchApi(unittest.TestCase):
    ...
    def test_get_watch_popular_episodes(self) -> None:
        """Test case for get_watch_popular_episodes

        """
        pass

    def test_get_watch_popular_promos(self) -> None:
        """Test case for get_watch_popular_promos

        """
        pass

    def test_get_watch_recent_episodes(self) -> None:
        """Test case for get_watch_recent_episodes

        """
        pass

    def test_get_watch_recent_promos(self) -> None:
        """Test case for get_watch_recent_promos

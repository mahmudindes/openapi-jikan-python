...
class TestCharacterPicturesDataInner(unittest.TestCase):
    """CharacterPicturesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterPicturesDataInner:
        """Test CharacterPicturesDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterPicturesDataInner`
        """
        model = CharacterPicturesDataInner()
        if include_optional:
            return CharacterPicturesDataInner(
                image_url = '',
                large_image_url = ''
            )
        else:
    ...
    def testCharacterPicturesDataInner(self):
        """Test CharacterPicturesDataInner"""

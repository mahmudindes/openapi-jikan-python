...
class TestCharactersSearchQueryOrderby(unittest.TestCase):
    """CharactersSearchQueryOrderby unit test stubs"""
    ...
    def testCharactersSearchQueryOrderby(self):
        """Test CharactersSearchQueryOrderby"""
        # inst = CharactersSearchQueryOrderby()

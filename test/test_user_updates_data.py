...
class TestUserUpdatesData(unittest.TestCase):
    """UserUpdatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserUpdatesData:
        """Test UserUpdatesData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserUpdatesData`
        """
        model = UserUpdatesData()
        if include_optional:

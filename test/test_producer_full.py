...
class TestProducerFull(unittest.TestCase):
    """ProducerFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProducerFull:
        """Test ProducerFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProducerFull`
        """
        model = ProducerFull()
        if include_optional:
            return ProducerFull(

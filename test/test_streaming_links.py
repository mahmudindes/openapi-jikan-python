...
class TestStreamingLinks(unittest.TestCase):
    """StreamingLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingLinks:
        """Test StreamingLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingLinks`
        """
        model = StreamingLinks()
        if include_optional:

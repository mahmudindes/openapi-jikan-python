...
class TestUsersSearch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersSearch:
        """Test UsersSearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersSearch`
        """
        model = UsersSearch()
        if include_optional:
            return UsersSearch(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.users_search_all_of_data.users_search_allOf_data(
                        url = '', 
                        username = '', 

...
class TestAnimeVideosEpisodes(unittest.TestCase):
    """AnimeVideosEpisodes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosEpisodes:
        """Test AnimeVideosEpisodes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosEpisodes`
        """
        model = AnimeVideosEpisodes()
        if include_optional:
            return AnimeVideosEpisodes(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.anime_videos_episodes_all_of_data.anime_videos_episodes_allOf_data(
                        mal_id = 56, 
                        title = '', 
                        episode = '', 
                        url = '', 
    ...
    def testAnimeVideosEpisodes(self):
        """Test AnimeVideosEpisodes"""

...
class TestMangaSearchQueryType(unittest.TestCase):
    """MangaSearchQueryType unit test stubs"""
    ...
    def testMangaSearchQueryType(self):
        """Test MangaSearchQueryType"""
        # inst = MangaSearchQueryType()

...
class TestWatchEpisodesAllOfData(unittest.TestCase):
    """WatchEpisodesAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatchEpisodesAllOfData:
        """Test WatchEpisodesAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchEpisodesAllOfData`
        """
        model = WatchEpisodesAllOfData()
        if include_optional:
            return WatchEpisodesAllOfData(
                entry = jikan_openapi.models.anime_meta.anime_meta(
                    ...
                    title = '', ),
                episodes = [
                    jikan_openapi.models.watch_episodes_all_of_episodes.watch_episodes_allOf_episodes(
                        mal_id = '', 
                        url = '', 
                        title = '', 
                        premium = True, )
    ...
    def testWatchEpisodesAllOfData(self):
        """Test WatchEpisodesAllOfData"""

...
class TestMangaImages(unittest.TestCase):
    """MangaImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaImages:
        """Test MangaImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaImages`
        """
        model = MangaImages()
        if include_optional:
            return MangaImages(

...
class TestClubMemberDataInner(unittest.TestCase):
    """ClubMemberDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubMemberDataInner:
        """Test ClubMemberDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubMemberDataInner`
        """
        model = ClubMemberDataInner()
        if include_optional:
            return ClubMemberDataInner(
                username = '',
                url = '',
    ...
    def testClubMemberDataInner(self):
        """Test ClubMemberDataInner"""

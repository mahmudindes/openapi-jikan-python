...
class TestGetTopReviews200ResponseData(unittest.TestCase):
    """GetTopReviews200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTopReviews200ResponseData:
        """Test GetTopReviews200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTopReviews200ResponseData`
        """
        model = GetTopReviews200ResponseData()
        if include_optional:
            return GetTopReviews200ResponseData(
    ...
    def testGetTopReviews200ResponseData(self):
        """Test GetTopReviews200ResponseData"""

...
class TestEntryRecommendations(unittest.TestCase):
    """EntryRecommendations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntryRecommendations:
        """Test EntryRecommendations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntryRecommendations`
        """
        model = EntryRecommendations()
        if include_optional:
    ...
    def testEntryRecommendations(self):
        """Test EntryRecommendations"""

...
class TestPersonFullMangaInner(unittest.TestCase):
    """PersonFullMangaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonFullMangaInner:
        """Test PersonFullMangaInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonFullMangaInner`
        """
        model = PersonFullMangaInner()
        if include_optional:
            return PersonFullMangaInner(
                position = '',
    ...
    def testPersonFullMangaInner(self):
        """Test PersonFullMangaInner"""

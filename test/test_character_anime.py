...
class TestCharacterAnime(unittest.TestCase):
    """CharacterAnime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterAnime:
        """Test CharacterAnime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterAnime`
        """

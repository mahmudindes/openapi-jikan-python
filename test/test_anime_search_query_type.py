...
class TestAnimeSearchQueryType(unittest.TestCase):
    """AnimeSearchQueryType unit test stubs"""
    ...
    def testAnimeSearchQueryType(self):
        """Test AnimeSearchQueryType"""
        # inst = AnimeSearchQueryType()

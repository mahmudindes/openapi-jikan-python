...
class TestUserUpdatesDataMangaInner(unittest.TestCase):
    """UserUpdatesDataMangaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserUpdatesDataMangaInner:
        """Test UserUpdatesDataMangaInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserUpdatesDataMangaInner`
        """
        model = UserUpdatesDataMangaInner()
        if include_optional:
            return UserUpdatesDataMangaInner(
                entry = jikan_openapi.models.manga_meta.manga_meta(
                    mal_id = 56, 
                    url = '', 
    ...
    def testUserUpdatesDataMangaInner(self):
        """Test UserUpdatesDataMangaInner"""

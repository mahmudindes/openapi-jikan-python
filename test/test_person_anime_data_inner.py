...
class TestPersonAnimeDataInner(unittest.TestCase):
    """PersonAnimeDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonAnimeDataInner:
        """Test PersonAnimeDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonAnimeDataInner`
        """
        model = PersonAnimeDataInner()
        if include_optional:
            return PersonAnimeDataInner(
                position = '',
    ...
    def testPersonAnimeDataInner(self):
        """Test PersonAnimeDataInner"""

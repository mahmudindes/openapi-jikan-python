...
class TestAnimeFull(unittest.TestCase):
    """AnimeFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeFull:
        """Test AnimeFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeFull`
        """
        model = AnimeFull()
        if include_optional:
            return AnimeFull(

...
class TestPictures(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Pictures:
        """Test Pictures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Pictures`
        """
        model = Pictures()
        if include_optional:
            return Pictures(
                data = [
                    jikan_openapi.models.pictures_data_inner.pictures_data_inner(

...
class TestSeasons(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Seasons:
        """Test Seasons
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Seasons`
        """
        model = Seasons()
        if include_optional:
            return Seasons(
                data = [
                    jikan_openapi.models.seasons_data_inner.seasons_data_inner(
                        year = 56, 
                        seasons = [
                            ''
                            ], )

...
class TestMangaMeta(unittest.TestCase):
    """MangaMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaMeta:
        """Test MangaMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaMeta`
        """
        model = MangaMeta()
        if include_optional:
            return MangaMeta(

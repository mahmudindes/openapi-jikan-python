...
class TestCharacterImagesWebp(unittest.TestCase):
    """CharacterImagesWebp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterImagesWebp:
        """Test CharacterImagesWebp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterImagesWebp`
        """
        model = CharacterImagesWebp()
        if include_optional:
    ...
    def testCharacterImagesWebp(self):
        """Test CharacterImagesWebp"""

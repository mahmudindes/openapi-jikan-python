...
class TestUserClubs(unittest.TestCase):
    """UserClubs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserClubs:
        """Test UserClubs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserClubs`
        """
        model = UserClubs()
        if include_optional:
            return UserClubs(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.user_clubs_all_of_data.user_clubs_allOf_data(
                        mal_id = 56, 
                        name = '', 
                        url = '', )
                    ]

...
class TestProducersQueryOrderby(unittest.TestCase):
    """ProducersQueryOrderby unit test stubs"""
    ...
    def testProducersQueryOrderby(self):
        """Test ProducersQueryOrderby"""
        # inst = ProducersQueryOrderby()

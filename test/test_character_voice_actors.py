...
class TestCharacterVoiceActors(unittest.TestCase):
    """CharacterVoiceActors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterVoiceActors:
        """Test CharacterVoiceActors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterVoiceActors`
        """
        model = CharacterVoiceActors()
        if include_optional:
    ...
    def testCharacterVoiceActors(self):
        """Test CharacterVoiceActors"""

...
class TestEntryMeta(unittest.TestCase):
    """EntryMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntryMeta:
        """Test EntryMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntryMeta`
        """
        model = EntryMeta()
        if include_optional:
            return EntryMeta(

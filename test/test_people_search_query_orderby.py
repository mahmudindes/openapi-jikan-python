...
class TestPeopleSearchQueryOrderby(unittest.TestCase):
    """PeopleSearchQueryOrderby unit test stubs"""
    ...
    def testPeopleSearchQueryOrderby(self):
        """Test PeopleSearchQueryOrderby"""
        # inst = PeopleSearchQueryOrderby()

...
class TestAnimeSearchQueryOrderby(unittest.TestCase):
    """AnimeSearchQueryOrderby unit test stubs"""
    ...
    def testAnimeSearchQueryOrderby(self):
        """Test AnimeSearchQueryOrderby"""
        # inst = AnimeSearchQueryOrderby()

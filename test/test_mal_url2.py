...
class TestMalUrl2(unittest.TestCase):
    """MalUrl2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MalUrl2:
        """Test MalUrl2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MalUrl2`
        """
        model = MalUrl2()
        if include_optional:
            return MalUrl2(

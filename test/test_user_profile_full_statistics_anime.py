...
class TestUserProfileFullStatisticsAnime(unittest.TestCase):
    """UserProfileFullStatisticsAnime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserProfileFullStatisticsAnime:
        """Test UserProfileFullStatisticsAnime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserProfileFullStatisticsAnime`
        """
        model = UserProfileFullStatisticsAnime()
        if include_optional:
    ...
    def testUserProfileFullStatisticsAnime(self):
        """Test UserProfileFullStatisticsAnime"""

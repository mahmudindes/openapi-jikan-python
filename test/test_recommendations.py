...
class TestRecommendations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Recommendations:
        """Test Recommendations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Recommendations`
        """
        ...
        if include_optional:
            return Recommendations(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.recommendations_all_of_data.recommendations_allOf_data(
                        mal_id = '', 
                        entry = [

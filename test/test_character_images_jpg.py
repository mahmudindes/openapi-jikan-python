...
class TestCharacterImagesJpg(unittest.TestCase):
    """CharacterImagesJpg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterImagesJpg:
        """Test CharacterImagesJpg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterImagesJpg`
        """
        model = CharacterImagesJpg()
        if include_optional:
    ...
    def testCharacterImagesJpg(self):
        """Test CharacterImagesJpg"""

...
class TestMangaSearchQueryStatus(unittest.TestCase):
    """MangaSearchQueryStatus unit test stubs"""
    ...
    def testMangaSearchQueryStatus(self):
        """Test MangaSearchQueryStatus"""
        # inst = MangaSearchQueryStatus()

...
class TestTrailerBase(unittest.TestCase):
    """TrailerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrailerBase:
        """Test TrailerBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrailerBase`
        """
        model = TrailerBase()
        if include_optional:
            return TrailerBase(

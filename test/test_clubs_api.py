...
class TestClubsApi(unittest.TestCase):
    ...
    def test_get_club_members(self) -> None:
        """Test case for get_club_members

        """
        pass

    def test_get_club_relations(self) -> None:
        """Test case for get_club_relations

        """
        pass

    def test_get_club_staff(self) -> None:
        """Test case for get_club_staff

        """
        pass

    def test_get_clubs_by_id(self) -> None:
        """Test case for get_clubs_by_id

        """
        pass

    def test_get_clubs_search(self) -> None:
        """Test case for get_clubs_search

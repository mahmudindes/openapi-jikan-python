...
class TestMangaReviewsAllOfData(unittest.TestCase):
    """MangaReviewsAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaReviewsAllOfData:
        """Test MangaReviewsAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaReviewsAllOfData`
        """
        model = MangaReviewsAllOfData()
        if include_optional:
            return MangaReviewsAllOfData(
                mal_id = 56,
                url = '',
                type = '',
    ...
    def testMangaReviewsAllOfData(self):
        """Test MangaReviewsAllOfData"""

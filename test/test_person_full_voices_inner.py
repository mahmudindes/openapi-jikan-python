...
class TestPersonFullVoicesInner(unittest.TestCase):
    """PersonFullVoicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonFullVoicesInner:
        """Test PersonFullVoicesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonFullVoicesInner`
        """
        model = PersonFullVoicesInner()
        if include_optional:
            return PersonFullVoicesInner(
                role = '',
    ...
    def testPersonFullVoicesInner(self):
        """Test PersonFullVoicesInner"""

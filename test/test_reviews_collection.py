...
class TestReviewsCollection(unittest.TestCase):
    """ReviewsCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewsCollection:
        """Test ReviewsCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewsCollection`
        """
        model = ReviewsCollection()
        if include_optional:
            return ReviewsCollection(
                data = [
                    jikan_openapi.models.reviews_collection_data_inner.reviews_collection_data_inner()
                    ]
            )
        else:
            return ReviewsCollection(
    ...
    def testReviewsCollection(self):
        """Test ReviewsCollection"""

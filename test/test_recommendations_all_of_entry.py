...
class TestRecommendationsAllOfEntry(unittest.TestCase):
    """RecommendationsAllOfEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendationsAllOfEntry:
        """Test RecommendationsAllOfEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendationsAllOfEntry`
        """
        model = RecommendationsAllOfEntry()
        if include_optional:
            return RecommendationsAllOfEntry(
                mal_id = 56,
                url = '',
    ...
    def testRecommendationsAllOfEntry(self):
        """Test RecommendationsAllOfEntry"""

...
class TestCharacterAnimeDataInner(unittest.TestCase):
    """CharacterAnimeDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterAnimeDataInner:
        """Test CharacterAnimeDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterAnimeDataInner`
        """
        model = CharacterAnimeDataInner()
        if include_optional:
            return CharacterAnimeDataInner(
                role = '',
    ...
    def testCharacterAnimeDataInner(self):
        """Test CharacterAnimeDataInner"""

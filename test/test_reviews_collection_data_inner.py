...
class TestReviewsCollectionDataInner(unittest.TestCase):
    """ReviewsCollectionDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewsCollectionDataInner:
        """Test ReviewsCollectionDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewsCollectionDataInner`
        """
        model = ReviewsCollectionDataInner()
        if include_optional:
            return ReviewsCollectionDataInner(
                mal_id = 56,
                url = '',
                type = '',
    ...
    def testReviewsCollectionDataInner(self):
        """Test ReviewsCollectionDataInner"""

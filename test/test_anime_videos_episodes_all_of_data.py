...
class TestAnimeVideosEpisodesAllOfData(unittest.TestCase):
    """AnimeVideosEpisodesAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosEpisodesAllOfData:
        """Test AnimeVideosEpisodesAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosEpisodesAllOfData`
        """
        model = AnimeVideosEpisodesAllOfData()
        if include_optional:
            return AnimeVideosEpisodesAllOfData(
                mal_id = 56,
                title = '',
                episode = '',
                url = '',
    ...
    def testAnimeVideosEpisodesAllOfData(self):
        """Test AnimeVideosEpisodesAllOfData"""

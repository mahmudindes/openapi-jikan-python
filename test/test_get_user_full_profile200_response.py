...
class TestGetUserFullProfile200Response(unittest.TestCase):
    """GetUserFullProfile200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserFullProfile200Response:
        """Test GetUserFullProfile200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserFullProfile200Response`
        """
        model = GetUserFullProfile200Response()
        if include_optional:
            return GetUserFullProfile200Response(
                data = jikan_openapi.models.user_profile_full.user_profile_full(
                    mal_id = 56, 
                    username = '', 
                    url = '', 
                    images = jikan_openapi.models.user_images.user_images(
                        jpg = jikan_openapi.models.user_images_jpg.user_images_jpg(
                            image_url = '', ), 
                        webp = jikan_openapi.models.user_images_webp.user_images_webp(
                            image_url = '', ), ), 
                    last_online = '', 
                    gender = '', 
                    birthday = '', 
                    location = '', 
                    joined = '', 
                    statistics = jikan_openapi.models.user_profile_full_statistics.user_profile_full_statistics(
                        anime = jikan_openapi.models.user_profile_full_statistics_anime.user_profile_full_statistics_anime(
                            days_watched = 1.337, 
                            mean_score = 1.337, 
                            watching = 56, 
                            completed = 56, 
                            ...
                            rewatched = 56, 
                            episodes_watched = 56, ), 
                        manga = jikan_openapi.models.user_profile_full_statistics_manga.user_profile_full_statistics_manga(
                            days_read = 1.337, 
                            mean_score = 1.337, 
                            reading = 56, 
                            completed = 56, 
                            ...
                            volumes_read = 56, ), ), 
                    external = [
                        jikan_openapi.models.anime_full_external_inner.anime_full_external_inner(
                            name = '', 
                            url = '', )
                        ], )
            )
    ...
    def testGetUserFullProfile200Response(self):
        """Test GetUserFullProfile200Response"""

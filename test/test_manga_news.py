...
class TestMangaNews(unittest.TestCase):
    """MangaNews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaNews:
        """Test MangaNews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaNews`
        """
        model = MangaNews()
        if include_optional:
            return MangaNews(

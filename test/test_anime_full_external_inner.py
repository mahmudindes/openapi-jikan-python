...
class TestAnimeFullExternalInner(unittest.TestCase):
    """AnimeFullExternalInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeFullExternalInner:
        """Test AnimeFullExternalInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeFullExternalInner`
        """
        model = AnimeFullExternalInner()
        if include_optional:
            return AnimeFullExternalInner(
                name = '',
                url = ''
            )
        else:
    ...
    def testAnimeFullExternalInner(self):
        """Test AnimeFullExternalInner"""

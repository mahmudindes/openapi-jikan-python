...
class TestClubStaffDataInner(unittest.TestCase):
    """ClubStaffDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClubStaffDataInner:
        """Test ClubStaffDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClubStaffDataInner`
        """
        model = ClubStaffDataInner()
        if include_optional:
            return ClubStaffDataInner(
                url = '',
                username = ''
            )
        else:
    ...
    def testClubStaffDataInner(self):
        """Test ClubStaffDataInner"""

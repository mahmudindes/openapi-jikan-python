...
class TestGetProducerFullById200Response(unittest.TestCase):
    """GetProducerFullById200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProducerFullById200Response:
        """Test GetProducerFullById200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProducerFullById200Response`
        """
        model = GetProducerFullById200Response()
        if include_optional:
            return GetProducerFullById200Response(
                data = jikan_openapi.models.producer_full.producer_full(
                    mal_id = 56, 
                    url = '', 
                    titles = [
    ...
    def testGetProducerFullById200Response(self):
        """Test GetProducerFullById200Response"""

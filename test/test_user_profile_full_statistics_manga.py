...
class TestUserProfileFullStatisticsManga(unittest.TestCase):
    """UserProfileFullStatisticsManga unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserProfileFullStatisticsManga:
        """Test UserProfileFullStatisticsManga
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserProfileFullStatisticsManga`
        """
        model = UserProfileFullStatisticsManga()
        if include_optional:
    ...
    def testUserProfileFullStatisticsManga(self):
        """Test UserProfileFullStatisticsManga"""

...
class TestMangaSearchQueryOrderby(unittest.TestCase):
    """MangaSearchQueryOrderby unit test stubs"""
    ...
    def testMangaSearchQueryOrderby(self):
        """Test MangaSearchQueryOrderby"""
        # inst = MangaSearchQueryOrderby()

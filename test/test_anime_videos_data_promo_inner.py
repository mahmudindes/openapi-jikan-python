...
class TestAnimeVideosDataPromoInner(unittest.TestCase):
    """AnimeVideosDataPromoInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosDataPromoInner:
        """Test AnimeVideosDataPromoInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosDataPromoInner`
        """
        model = AnimeVideosDataPromoInner()
        if include_optional:
            return AnimeVideosDataPromoInner(
                title = '',
    ...
    def testAnimeVideosDataPromoInner(self):
        """Test AnimeVideosDataPromoInner"""

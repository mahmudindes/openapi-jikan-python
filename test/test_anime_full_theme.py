...
class TestAnimeFullTheme(unittest.TestCase):
    """AnimeFullTheme unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeFullTheme:
        """Test AnimeFullTheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeFullTheme`
        """
        model = AnimeFullTheme()
        if include_optional:

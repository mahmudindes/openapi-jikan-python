...
class TestAnimeSearch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnimeSearch:
        """Test AnimeSearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeSearch`
        """
        model = AnimeSearch()
        if include_optional:
            return AnimeSearch(

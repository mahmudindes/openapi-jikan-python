...
class TestAnimeImages(unittest.TestCase):
    """AnimeImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeImages:
        """Test AnimeImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeImages`
        """
        model = AnimeImages()
        if include_optional:
            return AnimeImages(

...
class TestAnimeCharacters(unittest.TestCase):
    """AnimeCharacters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeCharacters:
        """Test AnimeCharacters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeCharacters`
        """
        model = AnimeCharacters()
        if include_optional:
            return AnimeCharacters(
                data = [
                    jikan_openapi.models.anime_characters_data_inner.anime_characters_data_inner(

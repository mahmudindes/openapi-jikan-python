...
class TestMoreinfoData(unittest.TestCase):
    """MoreinfoData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoreinfoData:
        """Test MoreinfoData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoreinfoData`
        """
        model = MoreinfoData()
        if include_optional:
            return MoreinfoData(

...
class TestAnimeStaff(unittest.TestCase):
    """AnimeStaff unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStaff:
        """Test AnimeStaff
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStaff`
        """
        model = AnimeStaff()
        if include_optional:
            return AnimeStaff(
                data = [
                    jikan_openapi.models.anime_staff_data_inner.anime_staff_data_inner(

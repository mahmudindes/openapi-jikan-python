...
class TestMangaFull(unittest.TestCase):
    """MangaFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaFull:
        """Test MangaFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaFull`
        """
        model = MangaFull()
        if include_optional:
            return MangaFull(

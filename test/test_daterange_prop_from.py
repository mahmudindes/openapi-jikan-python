...
class TestDaterangePropFrom(unittest.TestCase):
    """DaterangePropFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DaterangePropFrom:
        """Test DaterangePropFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DaterangePropFrom`
        """
        model = DaterangePropFrom()
        if include_optional:
    ...
    def testDaterangePropFrom(self):
        """Test DaterangePropFrom"""

...
class TestMangaCharactersDataInner(unittest.TestCase):
    """MangaCharactersDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaCharactersDataInner:
        """Test MangaCharactersDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaCharactersDataInner`
        """
        model = MangaCharactersDataInner()
        if include_optional:
            return MangaCharactersDataInner(
    ...
    def testMangaCharactersDataInner(self):
        """Test MangaCharactersDataInner"""

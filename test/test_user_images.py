...
class TestUserImages(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserImages:
        """Test UserImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserImages`
        """
        model = UserImages()
        if include_optional:
            return UserImages(

...
class TestPicturesDataInner(unittest.TestCase):
    """PicturesDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PicturesDataInner:
        """Test PicturesDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PicturesDataInner`
        """
        model = PicturesDataInner()
        if include_optional:
            return PicturesDataInner(
    ...
    def testPicturesDataInner(self):
        """Test PicturesDataInner"""

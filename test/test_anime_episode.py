...
class TestAnimeEpisode(unittest.TestCase):
    """AnimeEpisode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeEpisode:
        """Test AnimeEpisode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeEpisode`
        """
        model = AnimeEpisode()
        if include_optional:
            return AnimeEpisode(

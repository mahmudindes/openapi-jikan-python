...
class TestUsersTempDataInnerFavorites(unittest.TestCase):
    """UsersTempDataInnerFavorites unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTempDataInnerFavorites:
        """Test UsersTempDataInnerFavorites
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTempDataInnerFavorites`
        """
        model = UsersTempDataInnerFavorites()
        if include_optional:
            return UsersTempDataInnerFavorites(
                anime = [
    ...
    def testUsersTempDataInnerFavorites(self):
        """Test UsersTempDataInnerFavorites"""

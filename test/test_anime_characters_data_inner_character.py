...
class TestAnimeCharactersDataInnerCharacter(unittest.TestCase):
    """AnimeCharactersDataInnerCharacter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeCharactersDataInnerCharacter:
        """Test AnimeCharactersDataInnerCharacter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeCharactersDataInnerCharacter`
        """
        model = AnimeCharactersDataInnerCharacter()
        if include_optional:
            return AnimeCharactersDataInnerCharacter(
                mal_id = 56,
                url = '',
    ...
    def testAnimeCharactersDataInnerCharacter(self):
        """Test AnimeCharactersDataInnerCharacter"""

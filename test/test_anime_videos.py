...
class TestAnimeVideos(unittest.TestCase):
    """AnimeVideos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideos:
        """Test AnimeVideos
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideos`
        """
        model = AnimeVideos()
        if include_optional:
            return AnimeVideos(
                data = jikan_openapi.models.anime_videos_data.anime_videos_data(
                    promo = [
                        jikan_openapi.models.anime_videos_data_promo_inner.anime_videos_data_promo_inner(
                            title = '', 
                            trailer = jikan_openapi.models.trailer.trailer(), )
                        ], 
                    episodes = [
                        jikan_openapi.models.anime_videos_data_episodes_inner.anime_videos_data_episodes_inner(
                            mal_id = 56, 
                            url = '', 
                            title = '', 
                            episode = '', 
                            images = jikan_openapi.models.common_images.common_images(
                                jpg = jikan_openapi.models.user_images_jpg.user_images_jpg(
                                    image_url = '', ), ), )
                        ], 
                    music_videos = [
                        jikan_openapi.models.anime_videos_data_music_videos_inner.anime_videos_data_music_videos_inner(
                            title = '', 
                            video = jikan_openapi.models.trailer.trailer(), 
                            meta = jikan_openapi.models.anime_videos_data_music_videos_inner_meta.anime_videos_data_music_videos_inner_meta(
                                title = '', 
                                author = '', ), )
                        ], )
            )

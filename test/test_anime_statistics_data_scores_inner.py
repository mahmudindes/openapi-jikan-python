...
class TestAnimeStatisticsDataScoresInner(unittest.TestCase):
    """AnimeStatisticsDataScoresInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeStatisticsDataScoresInner:
        """Test AnimeStatisticsDataScoresInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeStatisticsDataScoresInner`
        """
        model = AnimeStatisticsDataScoresInner()
        if include_optional:
            return AnimeStatisticsDataScoresInner(
                score = 56,
                votes = 56,
                percentage = 1.337
            )
    ...
    def testAnimeStatisticsDataScoresInner(self):
        """Test AnimeStatisticsDataScoresInner"""

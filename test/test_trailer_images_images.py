...
class TestTrailerImagesImages(unittest.TestCase):
    """TrailerImagesImages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrailerImagesImages:
        """Test TrailerImagesImages
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrailerImagesImages`
        """
        model = TrailerImagesImages()
        if include_optional:
    ...
    def testTrailerImagesImages(self):
        """Test TrailerImagesImages"""

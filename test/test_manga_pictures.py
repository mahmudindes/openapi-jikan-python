...
class TestMangaPictures(unittest.TestCase):
    """MangaPictures unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MangaPictures:
        """Test MangaPictures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MangaPictures`
        """
        model = MangaPictures()
        if include_optional:
            return MangaPictures(
                data = [
                    jikan_openapi.models.manga_images.manga_images(

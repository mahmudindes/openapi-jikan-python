...
class TestUserFavoritesMangaInner(unittest.TestCase):
    """UserFavoritesMangaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserFavoritesMangaInner:
        """Test UserFavoritesMangaInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserFavoritesMangaInner`
        """
        model = UserFavoritesMangaInner()
        if include_optional:
            return UserFavoritesMangaInner(
                mal_id = 56,
                url = '',
    ...
    def testUserFavoritesMangaInner(self):
        """Test UserFavoritesMangaInner"""

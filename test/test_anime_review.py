...
class TestAnimeReview(unittest.TestCase):
    """AnimeReview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeReview:
        """Test AnimeReview
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeReview`
        """
        model = AnimeReview()
        if include_optional:
            return AnimeReview(

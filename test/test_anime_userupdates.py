...
class TestAnimeUserupdates(unittest.TestCase):
    """AnimeUserupdates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeUserupdates:
        """Test AnimeUserupdates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeUserupdates`
        """
        model = AnimeUserupdates()
        if include_optional:
            return AnimeUserupdates(
                pagination = jikan_openapi.models.pagination_pagination.pagination_pagination(
                    ...
                    has_next_page = True, ),
                data = [
                    jikan_openapi.models.anime_userupdates_all_of_data.anime_userupdates_allOf_data(

...
class TestSeasonsDataInner(unittest.TestCase):
    """SeasonsDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonsDataInner:
        """Test SeasonsDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonsDataInner`
        """
        model = SeasonsDataInner()
        if include_optional:
            return SeasonsDataInner(
                year = 56,
                seasons = [
                    ''
                    ]

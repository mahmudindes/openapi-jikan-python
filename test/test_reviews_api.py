...
class TestReviewsApi(unittest.TestCase):
    ...
    def test_get_recent_anime_reviews(self) -> None:
        """Test case for get_recent_anime_reviews

        """
        pass

    def test_get_recent_manga_reviews(self) -> None:
        """Test case for get_recent_manga_reviews

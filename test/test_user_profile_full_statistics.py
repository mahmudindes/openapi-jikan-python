...
class TestUserProfileFullStatistics(unittest.TestCase):
    """UserProfileFullStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserProfileFullStatistics:
        """Test UserProfileFullStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserProfileFullStatistics`
        """
        model = UserProfileFullStatistics()
        if include_optional:
    ...
    def testUserProfileFullStatistics(self):
        """Test UserProfileFullStatistics"""

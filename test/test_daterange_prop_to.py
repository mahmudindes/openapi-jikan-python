...
class TestDaterangePropTo(unittest.TestCase):
    """DaterangePropTo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DaterangePropTo:
        """Test DaterangePropTo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DaterangePropTo`
        """
        model = DaterangePropTo()
        if include_optional:

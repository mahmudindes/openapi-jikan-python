...
class TestUserAnimeListStatusFilter(unittest.TestCase):
    """UserAnimeListStatusFilter unit test stubs"""
    ...
    def testUserAnimeListStatusFilter(self):
        """Test UserAnimeListStatusFilter"""
        # inst = UserAnimeListStatusFilter()

...
class TestUsersTemp(unittest.TestCase):
    """UsersTemp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersTemp:
        """Test UsersTemp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersTemp`
        """
        model = UsersTemp()
        if include_optional:
            return UsersTemp(
                data = [
                    jikan_openapi.models.users_temp_data_inner.users_temp_data_inner(
                        mal_id = 56, 
                        username = '', 
                        url = '', 

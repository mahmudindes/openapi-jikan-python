...
class TestDaterangeProp(unittest.TestCase):
    """DaterangeProp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DaterangeProp:
        """Test DaterangeProp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DaterangeProp`
        """
        model = DaterangeProp()
        if include_optional:
            return DaterangeProp(
                var_from = jikan_openapi.models.daterange_prop_from.daterange_prop_from(
                    day = 56, 
                    month = 56, 
                    year = 56, ),

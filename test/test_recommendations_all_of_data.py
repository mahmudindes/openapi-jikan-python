...
class TestRecommendationsAllOfData(unittest.TestCase):
    """RecommendationsAllOfData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendationsAllOfData:
        """Test RecommendationsAllOfData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendationsAllOfData`
        """
        model = RecommendationsAllOfData()
        if include_optional:
            return RecommendationsAllOfData(
                mal_id = '',
                entry = [
                    jikan_openapi.models.recommendations_all_of_entry.recommendations_allOf_entry()
                    ],
                content = '',
                user = jikan_openapi.models.user_by_id.user_by_id(
                    url = '', 
                    username = '', )
            )
        else:
    ...
    def testRecommendationsAllOfData(self):
        """Test RecommendationsAllOfData"""

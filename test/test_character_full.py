...
class TestCharacterFull(unittest.TestCase):
    """CharacterFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacterFull:
        """Test CharacterFull
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacterFull`
        """
        model = CharacterFull()
        if include_optional:
            return CharacterFull(
                ...
                about = '',
                anime = [
                    jikan_openapi.models.character_anime_data_inner.character_anime_data_inner(
                        role = '', 
                        anime = jikan_openapi.models.anime_meta.anime_meta(
                            mal_id = 56, 
                            url = '', 
                ...
                manga = [
                    jikan_openapi.models.character_full_manga_inner.character_full_manga_inner(
                        role = '', 
                        manga = jikan_openapi.models.manga_meta.manga_meta(
                            mal_id = 56, 
                            url = '', 
                            images = jikan_openapi.models.manga_images.manga_images(
                                jpg = jikan_openapi.models.anime_images_jpg.anime_images_jpg(
                                    image_url = '', 
                                    small_image_url = '', 
                                    large_image_url = '', ), 
                ...
                voices = [
                    jikan_openapi.models.character_full_voices_inner.character_full_voices_inner(
                        language = '', 
                        person = jikan_openapi.models.person_meta.person_meta(
                            mal_id = 56, 
                            url = '', 

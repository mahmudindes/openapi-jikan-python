...
class TestAnimeSearchQueryRating(unittest.TestCase):
    """AnimeSearchQueryRating unit test stubs"""
    ...
    def testAnimeSearchQueryRating(self):
        """Test AnimeSearchQueryRating"""
        # inst = AnimeSearchQueryRating()

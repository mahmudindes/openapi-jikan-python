...
class TestPicturesVariants(unittest.TestCase):
    """PicturesVariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PicturesVariants:
        """Test PicturesVariants
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PicturesVariants`
        """
        model = PicturesVariants()
        if include_optional:
            return PicturesVariants(
                data = [
                    jikan_openapi.models.pictures_variants_data_inner.pictures_variants_data_inner(

...
class TestRandomDataInner(unittest.TestCase):
    """RandomDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RandomDataInner:
        """Test RandomDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RandomDataInner`
        """
        model = RandomDataInner()
        if include_optional:
            return RandomDataInner(
                mal_id = 56,
                url = '',

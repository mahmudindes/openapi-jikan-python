...
class TestUserMangaListStatusFilter(unittest.TestCase):
    """UserMangaListStatusFilter unit test stubs"""
    ...
    def testUserMangaListStatusFilter(self):
        """Test UserMangaListStatusFilter"""
        # inst = UserMangaListStatusFilter()

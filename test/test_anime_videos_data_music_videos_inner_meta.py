...
class TestAnimeVideosDataMusicVideosInnerMeta(unittest.TestCase):
    """AnimeVideosDataMusicVideosInnerMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosDataMusicVideosInnerMeta:
        """Test AnimeVideosDataMusicVideosInnerMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosDataMusicVideosInnerMeta`
        """
        model = AnimeVideosDataMusicVideosInnerMeta()
        if include_optional:
            return AnimeVideosDataMusicVideosInnerMeta(
                title = '',
                author = ''
            )
        else:
    ...
    def testAnimeVideosDataMusicVideosInnerMeta(self):
        """Test AnimeVideosDataMusicVideosInnerMeta"""

...
class TestAnimeVideosDataEpisodesInner(unittest.TestCase):
    """AnimeVideosDataEpisodesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnimeVideosDataEpisodesInner:
        """Test AnimeVideosDataEpisodesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnimeVideosDataEpisodesInner`
        """
        model = AnimeVideosDataEpisodesInner()
        if include_optional:
            return AnimeVideosDataEpisodesInner(
                mal_id = 56,
                url = '',
                title = '',
                episode = '',
    ...
    def testAnimeVideosDataEpisodesInner(self):
        """Test AnimeVideosDataEpisodesInner"""

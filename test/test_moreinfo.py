...
class TestMoreinfo(unittest.TestCase):
    """Moreinfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Moreinfo:
        """Test Moreinfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Moreinfo`
        """
        model = Moreinfo()
        if include_optional:
            return Moreinfo(
                data = jikan_openapi.models.moreinfo_data.moreinfo_data(
                    moreinfo = '', )
            )
        else:
            return Moreinfo(

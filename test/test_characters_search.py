...
class TestCharactersSearch(unittest.TestCase):
    """CharactersSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharactersSearch:
        """Test CharactersSearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharactersSearch`
        """
        model = CharactersSearch()
        if include_optional:
            return CharactersSearch(
                pagination = jikan_openapi.models.pagination_plus_pagination.pagination_plus_pagination(
                    ...
                    items = jikan_openapi.models.pagination_plus_pagination_items.pagination_plus_pagination_items(
                        ...
                        per_page = 56, ), ),
                data = [
                    jikan_openapi.models.character.character(
                        mal_id = 56, 
                        url = '', 

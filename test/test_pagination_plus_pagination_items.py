...
class TestPaginationPlusPaginationItems(unittest.TestCase):
    """PaginationPlusPaginationItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginationPlusPaginationItems:
        """Test PaginationPlusPaginationItems
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginationPlusPaginationItems`
        """
        model = PaginationPlusPaginationItems()
        if include_optional:
    ...
    def testPaginationPlusPaginationItems(self):
        """Test PaginationPlusPaginationItems"""

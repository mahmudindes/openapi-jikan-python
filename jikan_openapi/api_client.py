...
from jikan_openapi.api_response import ApiResponse, T as ApiResponseT
import jikan_openapi.models
from jikan_openapi import rest
from jikan_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(jikan_openapi.models, klass)

...
class MagazinesApi:
    ...
    def get_magazines(
        ...
        order_by: Optional[MagazinesQueryOrderby] = None,
        ...
        :type q: str
        :param order_by:
        :type order_by: MagazinesQueryOrderby
        :param sort:
        ...
        _param = self._get_magazines_serialize(
            page=page,
            limit=limit,
            q=q,
            order_by=order_by,
    ...
    @validate_call
    def get_magazines_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        q: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_magazines_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        q: Optional[StrictStr] = None,

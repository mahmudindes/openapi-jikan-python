...
class ClubsApi:
    ...
    def get_club_members_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetClubMembers200Response]:
        """get_club_members
    ...
    def _get_club_members_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clubs/{id}/members',
    ...
    def get_club_relations(
        ...
        _param = self._get_club_relations_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_club_relations_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_club_relations_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_club_relations_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clubs/{id}/relations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_club_staff(
        ...
        _param = self._get_club_staff_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_club_staff_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_club_staff_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def get_clubs_by_id(
        ...
        _param = self._get_clubs_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_clubs_by_id_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetClubsById200Response]:
        """get_clubs_by_id
    ...
    @validate_call
    def get_clubs_by_id_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_clubs_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_clubs_search(
        ...
        type: Optional[ClubSearchQueryType] = None,
        category: Optional[ClubSearchQueryCategory] = None,
        order_by: Optional[ClubSearchQueryOrderby] = None,
        ...
        :type q: str
        :param type:
        :type type: ClubSearchQueryType
        :param category:
        :type category: ClubSearchQueryCategory
        :param order_by:
        :type order_by: ClubSearchQueryOrderby
        :param sort:
        ...
        _param = self._get_clubs_search_serialize(
            page=page,
            limit=limit,
            q=q,
            type=type,
    ...
    @validate_call
    def get_clubs_search_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        q: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_clubs_search_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        q: Optional[StrictStr] = None,
    ...
    def _get_clubs_search_serialize(
        self,
        page,
        limit,
        q,

...
class GenresApi:
    ...
    def get_anime_genres(
        self,
        filter: Optional[GenreQueryFilter] = None,
        ...
        _param = self._get_anime_genres_serialize(
            filter=filter,
    ...
    @validate_call
    def get_anime_genres_with_http_info(
        self,
        filter: Optional[GenreQueryFilter] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_anime_genres_without_preload_content(
        self,
        filter: Optional[GenreQueryFilter] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_anime_genres_serialize(
        self,
        filter,
        _request_auth,
        _content_type,
    ...
    def get_manga_genres(
        ...
        _param = self._get_manga_genres_serialize(
            filter=filter,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_manga_genres_with_http_info(
        self,
        filter: Optional[GenreQueryFilter] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_manga_genres_without_preload_content(
        self,
        filter: Optional[GenreQueryFilter] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_manga_genres_serialize(
        self,
        filter,
        _request_auth,
        _content_type,

...
class RecommendationsApi:
    ...
    @validate_call
    def get_recent_anime_recommendations(
        self,
        ...
        _param = self._get_recent_anime_recommendations_serialize(
            page=page,
    ...
    @validate_call
    def get_recent_anime_recommendations_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_recent_anime_recommendations_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_recent_anime_recommendations_serialize(
        self,
        page,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/recommendations/anime',
    ...
    @validate_call
    def get_recent_manga_recommendations(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_recent_manga_recommendations_serialize(
            page=page,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_recent_manga_recommendations_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_recent_manga_recommendations_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_recent_manga_recommendations_serialize(
        self,
        page,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/recommendations/manga',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
class SchedulesApi:
    ...
    def get_schedules(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by day")] = None,
        kids: Annotated[Optional[StrictStr], Field(description="When supplied, it will filter entries with the `Kids` Genre Demographic. When supplied as `kids=true`, it will return only Kid entries and when supplied as `kids=false`, it will filter out any Kid entries. Defaults to `false`.")] = None,
        sfw: Annotated[Optional[StrictStr], Field(description="'Safe For Work'. When supplied, it will filter entries with the `Hentai` Genre. When supplied as `sfw=true`, it will return only SFW entries and when supplied as `sfw=false`, it will filter out any Hentai entries. Defaults to `false`.")] = None,
    ...
    def _get_schedules_serialize(
        ...
        if kids is not None:
            ...
            _query_params.append(('kids', kids))

...
class SeasonsApi:
    ...
    def get_season(
        ...
        year: StrictInt,
        season: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="Entry types")] = None,
        sfw: Annotated[Optional[StrictBool], Field(description="'Safe For Work'. This is a flag. When supplied it will filter out entries according to the SFW Policy. You do not need to pass a value to it. e.g usage: `?sfw`")] = None,
        ...
        continuing: Annotated[Optional[StrictBool], Field(description="This is a flag. When supplied it will include entries which are continuing from previous seasons. MAL includes these items on the seasons view in the &#8243;TV (continuing)&#8243; section. (Example: https://myanimelist.net/anime/season/2024/winter) <br />Example usage: `?continuing`")] = None,
        ...
        :param continuing: This is a flag. When supplied it will include entries which are continuing from previous seasons. MAL includes these items on the seasons view in the &#8243;TV (continuing)&#8243; section. (Example: https://myanimelist.net/anime/season/2024/winter) <br />Example usage: `?continuing`
    ...
    def _get_season_serialize(
        ...
        if continuing is not None:
            ...
            _query_params.append(('continuing', continuing))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/seasons/{year}/{season}',
    ...
    def get_season_now(
        ...
        _param = self._get_season_now_serialize(
            filter=filter,
            sfw=sfw,
            unapproved=unapproved,
            continuing=continuing,
    ...
    @validate_call
    def get_season_now_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Entry types")] = None,
        sfw: Annotated[Optional[StrictBool], Field(description="'Safe For Work'. This is a flag. When supplied it will filter out entries according to the SFW Policy. You do not need to pass a value to it. e.g usage: `?sfw`")] = None,
        unapproved: Annotated[Optional[StrictBool], Field(description="This is a flag. When supplied it will include entries which are unapproved. Unapproved entries on MyAnimeList are those that are user submitted and have not yet been approved by MAL to show up on other pages. They will have their own specifc pages and are often removed resulting in a 404 error. You do not need to pass a value to it. e.g usage: `?unapproved`")] = None,
    ...
    @validate_call
    def get_season_now_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Entry types")] = None,
        sfw: Annotated[Optional[StrictBool], Field(description="'Safe For Work'. This is a flag. When supplied it will filter out entries according to the SFW Policy. You do not need to pass a value to it. e.g usage: `?sfw`")] = None,
        unapproved: Annotated[Optional[StrictBool], Field(description="This is a flag. When supplied it will include entries which are unapproved. Unapproved entries on MyAnimeList are those that are user submitted and have not yet been approved by MAL to show up on other pages. They will have their own specifc pages and are often removed resulting in a 404 error. You do not need to pass a value to it. e.g usage: `?unapproved`")] = None,
    ...
    def get_season_upcoming(
        ...
        _param = self._get_season_upcoming_serialize(
            filter=filter,
            sfw=sfw,
            unapproved=unapproved,
            continuing=continuing,
    ...
    @validate_call
    def get_season_upcoming_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Entry types")] = None,
        sfw: Annotated[Optional[StrictBool], Field(description="'Safe For Work'. This is a flag. When supplied it will filter out entries according to the SFW Policy. You do not need to pass a value to it. e.g usage: `?sfw`")] = None,
        unapproved: Annotated[Optional[StrictBool], Field(description="This is a flag. When supplied it will include entries which are unapproved. Unapproved entries on MyAnimeList are those that are user submitted and have not yet been approved by MAL to show up on other pages. They will have their own specifc pages and are often removed resulting in a 404 error. You do not need to pass a value to it. e.g usage: `?unapproved`")] = None,
    ...
    @validate_call
    def get_season_upcoming_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Entry types")] = None,
        sfw: Annotated[Optional[StrictBool], Field(description="'Safe For Work'. This is a flag. When supplied it will filter out entries according to the SFW Policy. You do not need to pass a value to it. e.g usage: `?sfw`")] = None,
        unapproved: Annotated[Optional[StrictBool], Field(description="This is a flag. When supplied it will include entries which are unapproved. Unapproved entries on MyAnimeList are those that are user submitted and have not yet been approved by MAL to show up on other pages. They will have their own specifc pages and are often removed resulting in a 404 error. You do not need to pass a value to it. e.g usage: `?unapproved`")] = None,
    ...
    def _get_season_upcoming_serialize(
        self,
        filter,
        sfw,
        unapproved,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/seasons/upcoming',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_seasons_list(
        ...
        _param = self._get_seasons_list_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_seasons_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_seasons_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_seasons_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,

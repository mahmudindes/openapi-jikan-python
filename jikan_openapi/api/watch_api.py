...
class WatchApi:
    ...
    @validate_call
    def get_watch_popular_episodes(
        self,
        ...
        _param = self._get_watch_popular_episodes_serialize(
    ...
    @validate_call
    def get_watch_popular_episodes_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_watch_popular_episodes_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_watch_popular_episodes_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/watch/episodes/popular',
    ...
    def get_watch_popular_promos(
        ...
        _param = self._get_watch_popular_promos_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_watch_popular_promos_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_watch_popular_promos_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_watch_popular_promos_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/watch/promos/popular',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_watch_recent_episodes(
        ...
        _param = self._get_watch_recent_episodes_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_watch_recent_episodes_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_watch_recent_episodes_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_watch_recent_episodes_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_watch_recent_promos(
        ...
        _param = self._get_watch_recent_promos_serialize(
            page=page,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_watch_recent_promos_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_watch_recent_promos_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_watch_recent_promos_serialize(
        self,
        page,
        _request_auth,
        _content_type,

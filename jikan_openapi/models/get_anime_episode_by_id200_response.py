...
class GetAnimeEpisodeById200Response(BaseModel):
    """
    GetAnimeEpisodeById200Response
    """ # noqa: E501
    data: Optional[AnimeEpisode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AnimeEpisode.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj

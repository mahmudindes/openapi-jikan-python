...
class MangaUserupdatesAllOfData(BaseModel):
    """
    ...
    volumes_read: Optional[StrictInt] = Field(default=None, description="Number of volumes read")
    volumes_total: Optional[StrictInt] = Field(default=None, description="Total number of volumes")
    chapters_read: Optional[StrictInt] = Field(default=None, description="Number of chapters read")
    chapters_total: Optional[StrictInt] = Field(default=None, description="Total number of chapters")
    var_date: Optional[StrictStr] = Field(default=None, description="Last updated date ISO8601", alias="date")
    __properties: ClassVar[List[str]] = ["user", "score", "status", "volumes_read", "volumes_total", "chapters_read", "chapters_total", "date"]

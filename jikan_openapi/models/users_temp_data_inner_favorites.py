...
class UsersTempDataInnerFavorites(BaseModel):
    """
    Favorite entries
    """ # noqa: E501
    anime: Optional[List[EntryMeta]] = Field(default=None, description="Favorite Anime")
    manga: Optional[List[EntryMeta]] = Field(default=None, description="Favorite Manga")
    characters: Optional[List[EntryMeta]] = Field(default=None, description="Favorite Characters")
    people: Optional[List[EntryMeta]] = Field(default=None, description="Favorite People")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anime": [EntryMeta.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [EntryMeta.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None,
            "characters": [EntryMeta.from_dict(_item) for _item in obj["characters"]] if obj.get("characters") is not None else None,
            "people": [EntryMeta.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None
        })
        return _obj

...
class UserUpdatesData(BaseModel):
    """
    UserUpdatesData
    """ # noqa: E501
    anime: Optional[List[UserUpdatesDataAnimeInner]] = Field(default=None, description="Last updated Anime")
    manga: Optional[List[UserUpdatesDataMangaInner]] = Field(default=None, description="Last updated Manga")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anime": [UserUpdatesDataAnimeInner.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [UserUpdatesDataMangaInner.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None
        })
        return _obj

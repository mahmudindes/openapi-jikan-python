...
class UserImages(BaseModel):
    ...
    UserImages
    """ # noqa: E501
    jpg: Optional[UserImagesJpg] = None
    webp: Optional[UserImagesWebp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jpg": UserImagesJpg.from_dict(obj["jpg"]) if obj.get("jpg") is not None else None,
            "webp": UserImagesWebp.from_dict(obj["webp"]) if obj.get("webp") is not None else None
        })
        return _obj

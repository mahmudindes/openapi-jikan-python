...
class UserFavoritesAnimeInner(BaseModel):
    """
    ...
    title: Optional[StrictStr] = Field(default=None, description="Entry title")
    type: Optional[StrictStr] = None
    start_year: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "images", "title", "type", "start_year"]

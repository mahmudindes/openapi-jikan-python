...
class UserProfileFullStatisticsManga(BaseModel):
    """
    Manga Statistics
    """ # noqa: E501
    days_read: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of days spent reading Manga")
    mean_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Mean Score")
    reading: Optional[StrictInt] = Field(default=None, description="Manga Reading")
    completed: Optional[StrictInt] = Field(default=None, description="Manga Completed")
    on_hold: Optional[StrictInt] = Field(default=None, description="Manga On-Hold")
    dropped: Optional[StrictInt] = Field(default=None, description="Manga Dropped")
    plan_to_read: Optional[StrictInt] = Field(default=None, description="Manga Planned to Read")
    total_entries: Optional[StrictInt] = Field(default=None, description="Total Manga entries on User list")
    reread: Optional[StrictInt] = Field(default=None, description="Manga re-read")
    chapters_read: Optional[StrictInt] = Field(default=None, description="Number of Manga Chapters Read")
    volumes_read: Optional[StrictInt] = Field(default=None, description="Number of Manga Volumes Read")
    __properties: ClassVar[List[str]] = ["days_read", "mean_score", "reading", "completed", "on_hold", "dropped", "plan_to_read", "total_entries", "reread", "chapters_read", "volumes_read"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days_read": obj.get("days_read"),
            "mean_score": obj.get("mean_score"),
            "reading": obj.get("reading"),
            "completed": obj.get("completed"),
            "on_hold": obj.get("on_hold"),
            "dropped": obj.get("dropped"),
            "plan_to_read": obj.get("plan_to_read"),
            "total_entries": obj.get("total_entries"),
            "reread": obj.get("reread"),
            "chapters_read": obj.get("chapters_read"),
            "volumes_read": obj.get("volumes_read")
        })
        return _obj

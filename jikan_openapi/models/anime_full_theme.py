...
class AnimeFullTheme(BaseModel):
    """
    AnimeFullTheme
    """ # noqa: E501
    openings: Optional[List[StrictStr]] = None
    endings: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["openings", "endings"]

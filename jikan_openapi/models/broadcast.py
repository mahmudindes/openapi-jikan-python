...
class Broadcast(BaseModel):
    ...
    Broadcast Details
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Day of the week")
    time: Optional[StrictStr] = Field(default=None, description="Time in 24 hour format")
    timezone: Optional[StrictStr] = Field(default=None, description="Timezone (Tz Database format https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)")
    string: Optional[StrictStr] = Field(default=None, description="Raw parsed broadcast string")
    __properties: ClassVar[List[str]] = ["day", "time", "timezone", "string"]

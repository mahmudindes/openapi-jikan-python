...
class GetCharacterFullById200Response(BaseModel):
    """
    GetCharacterFullById200Response
    """ # noqa: E501
    data: Optional[CharacterFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CharacterFull.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj

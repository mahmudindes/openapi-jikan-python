...
class UserFavoritesCharactersInner(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Entry name")
    type: Optional[StrictStr] = Field(default=None, description="Type of resource")
    title: Optional[StrictStr] = Field(default=None, description="Resource Name/Title")
    __properties: ClassVar[List[str]] = ["mal_id", "url", "images", "name", "type", "title"]

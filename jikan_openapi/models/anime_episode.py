...
class AnimeEpisode(BaseModel):
    ...
    synopsis: Optional[StrictStr] = Field(default=None, description="Episode Synopsis")
    __properties: ClassVar[List[str]] = ["mal_id", "url", "title", "title_japanese", "title_romanji", "duration", "aired", "filler", "recap", "synopsis"]

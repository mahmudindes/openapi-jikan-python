...
class ProducerFull(BaseModel):
    ...
    favorites: Optional[StrictInt] = Field(default=None, description="Producers's member favorites count")
    count: Optional[StrictInt] = Field(default=None, description="Producers's anime count")
    established: Optional[StrictStr] = Field(default=None, description="Established Date ISO8601")
    about: Optional[StrictStr] = Field(default=None, description="About the Producer")
    external: Optional[List[AnimeFullExternalInner]] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "titles", "images", "favorites", "count", "established", "about", "external"]

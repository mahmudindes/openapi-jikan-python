...
class Relation(BaseModel):
    ...
    entry: Optional[List[MalUrl]] = Field(default=None, description="Related entries")
    __properties: ClassVar[List[str]] = ["relation", "entry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entry": [MalUrl.from_dict(_item) for _item in obj["entry"]] if obj.get("entry") is not None else None
        })
        return _obj

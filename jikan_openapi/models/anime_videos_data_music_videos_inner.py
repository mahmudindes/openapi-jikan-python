...
class AnimeVideosDataMusicVideosInner(BaseModel):
    """
    AnimeVideosDataMusicVideosInner
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Title")
    video: Optional[Trailer] = None
    meta: Optional[AnimeVideosDataMusicVideosInnerMeta] = None
    __properties: ClassVar[List[str]] = ["title", "video", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "video": Trailer.from_dict(obj["video"]) if obj.get("video") is not None else None,
            "meta": AnimeVideosDataMusicVideosInnerMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj

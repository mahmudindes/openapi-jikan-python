...
class AnimeFull(BaseModel):
    ...
    trailer: Optional[TrailerBase] = None
    ...
    title_synonyms: Optional[List[StrictStr]] = Field(default=None, description="Other Titles")
    type: Optional[StrictStr] = Field(default=None, description="Anime Type")
    source: Optional[StrictStr] = Field(default=None, description="Original Material/Source adapted from")
    episodes: Optional[StrictInt] = Field(default=None, description="Episode count")
    status: Optional[StrictStr] = Field(default=None, description="Airing status")
    airing: Optional[StrictBool] = Field(default=None, description="Airing boolean")
    aired: Optional[Daterange] = None
    duration: Optional[StrictStr] = Field(default=None, description="Parsed raw duration")
    rating: Optional[StrictStr] = Field(default=None, description="Anime audience rating")
    ...
    season: Optional[StrictStr] = Field(default=None, description="Season")
    year: Optional[StrictInt] = Field(default=None, description="Year")
    broadcast: Optional[Broadcast] = None
    producers: Optional[List[MalUrl]] = None
    licensors: Optional[List[MalUrl]] = None
    studios: Optional[List[MalUrl]] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TV', 'OVA', 'Movie', 'Special', 'ONA', 'Music']):
            raise ValueError("must be one of enum values ('TV', 'OVA', 'Movie', 'Special', 'ONA', 'Music')")
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Finished Airing', 'Currently Airing', 'Not yet aired']):
            raise ValueError("must be one of enum values ('Finished Airing', 'Currently Airing', 'Not yet aired')")
        return value
    ...
    def rating_validate_enum(cls, value):
        ...
        if value not in set(['G - All Ages', 'PG - Children', 'PG-13 - Teens 13 or older', 'R - 17+ (violence & profanity)', 'R+ - Mild Nudity', 'Rx - Hentai']):
            raise ValueError("must be one of enum values ('G - All Ages', 'PG - Children', 'PG-13 - Teens 13 or older', 'R - 17+ (violence & profanity)', 'R+ - Mild Nudity', 'Rx - Hentai')")
        return value
    ...
    def season_validate_enum(cls, value):
        ...
        if value not in set(['summer', 'winter', 'spring', 'fall']):
            raise ValueError("must be one of enum values ('summer', 'winter', 'spring', 'fall')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.titles:
            ...
            _dict['titles'] = _items
        # override the default output from pydantic by calling `to_dict()` of aired
        if self.aired:
            _dict['aired'] = self.aired.to_dict()
        # override the default output from pydantic by calling `to_dict()` of broadcast
        if self.broadcast:
            _dict['broadcast'] = self.broadcast.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in licensors (list)
        _items = []
        if self.licensors:
            for _item in self.licensors:
                if _item:
                    _items.append(_item.to_dict())
            _dict['licensors'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in streaming (list)
        _items = []
        if self.streaming:
            for _item in self.streaming:
                if _item:
                    _items.append(_item.to_dict())
            _dict['streaming'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "images": AnimeImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "trailer": TrailerBase.from_dict(obj["trailer"]) if obj.get("trailer") is not None else None,
            ...
            "title_synonyms": obj.get("title_synonyms"),
            "type": obj.get("type"),
            "source": obj.get("source"),
            "episodes": obj.get("episodes"),
            "status": obj.get("status"),
            "airing": obj.get("airing"),
            "aired": Daterange.from_dict(obj["aired"]) if obj.get("aired") is not None else None,
            ...
            "year": obj.get("year"),
            "broadcast": Broadcast.from_dict(obj["broadcast"]) if obj.get("broadcast") is not None else None,
            "producers": [MalUrl.from_dict(_item) for _item in obj["producers"]] if obj.get("producers") is not None else None,
            "licensors": [MalUrl.from_dict(_item) for _item in obj["licensors"]] if obj.get("licensors") is not None else None,
            "studios": [MalUrl.from_dict(_item) for _item in obj["studios"]] if obj.get("studios") is not None else None,
            ...
            "relations": [AnimeFullRelationsInner.from_dict(_item) for _item in obj["relations"]] if obj.get("relations") is not None else None,
            "theme": AnimeFullTheme.from_dict(obj["theme"]) if obj.get("theme") is not None else None,
            "external": [AnimeFullExternalInner.from_dict(_item) for _item in obj["external"]] if obj.get("external") is not None else None,
            "streaming": [AnimeFullExternalInner.from_dict(_item) for _item in obj["streaming"]] if obj.get("streaming") is not None else None
        })
        return _obj

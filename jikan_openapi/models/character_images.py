...
class CharacterImages(BaseModel):
    ...
    CharacterImages
    """ # noqa: E501
    jpg: Optional[CharacterImagesJpg] = None
    webp: Optional[CharacterImagesWebp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jpg": CharacterImagesJpg.from_dict(obj["jpg"]) if obj.get("jpg") is not None else None,
            "webp": CharacterImagesWebp.from_dict(obj["webp"]) if obj.get("webp") is not None else None
        })
        return _obj

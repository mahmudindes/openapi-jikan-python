...
class AnimeStatisticsData(BaseModel):
    """
    AnimeStatisticsData
    """ # noqa: E501
    watching: Optional[StrictInt] = Field(default=None, description="Number of users watching the resource")
    completed: Optional[StrictInt] = Field(default=None, description="Number of users who have completed the resource")
    on_hold: Optional[StrictInt] = Field(default=None, description="Number of users who have put the resource on hold")
    dropped: Optional[StrictInt] = Field(default=None, description="Number of users who have dropped the resource")
    plan_to_watch: Optional[StrictInt] = Field(default=None, description="Number of users who have planned to watch the resource")
    total: Optional[StrictInt] = Field(default=None, description="Total number of users who have the resource added to their lists")
    scores: Optional[List[AnimeStatisticsDataScoresInner]] = None
    __properties: ClassVar[List[str]] = ["watching", "completed", "on_hold", "dropped", "plan_to_watch", "total", "scores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "scores": [AnimeStatisticsDataScoresInner.from_dict(_item) for _item in obj["scores"]] if obj.get("scores") is not None else None
        })
        return _obj

...
class SeasonsDataInner(BaseModel):
    """
    SeasonsDataInner
    """ # noqa: E501
    year: Optional[StrictInt] = Field(default=None, description="Year")
    seasons: Optional[List[StrictStr]] = Field(default=None, description="List of available seasons")
    __properties: ClassVar[List[str]] = ["year", "seasons"]

...
class Magazine(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Magazine Name")
    url: Optional[StrictStr] = Field(default=None, description="MyAnimeList URL")
    count: Optional[StrictInt] = Field(default=None, description="Magazine's manga count")
    __properties: ClassVar[List[str]] = ["mal_id", "name", "url", "count"]

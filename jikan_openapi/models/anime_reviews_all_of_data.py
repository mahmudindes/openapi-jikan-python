...
class AnimeReviewsAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mal_id", "url", "type", "reactions", "date", "review", "score", "tags", "is_spoiler", "is_preliminary", "episodes_watched", "user"]

...
class AnimeImages(BaseModel):
    ...
    AnimeImages
    """ # noqa: E501
    jpg: Optional[AnimeImagesJpg] = None
    webp: Optional[AnimeImagesWebp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jpg": AnimeImagesJpg.from_dict(obj["jpg"]) if obj.get("jpg") is not None else None,
            "webp": AnimeImagesWebp.from_dict(obj["webp"]) if obj.get("webp") is not None else None
        })
        return _obj

...
class CharacterFull(BaseModel):
    ...
    name_kanji: Optional[StrictStr] = Field(default=None, description="Name")
    nicknames: Optional[List[StrictStr]] = Field(default=None, description="Other Names")
    ...
    anime: Optional[List[CharacterAnimeDataInner]] = None
    manga: Optional[List[CharacterFullMangaInner]] = None
    voices: Optional[List[CharacterFullVoicesInner]] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "images", "name", "name_kanji", "nicknames", "favorites", "about", "anime", "manga", "voices"]
        ...
        if self.voices:
            for _item in self.voices:
                if _item:
                    _items.append(_item.to_dict())
            _dict['voices'] = _items
        # set to None if name_kanji (nullable) is None
        # and model_fields_set contains the field
        if self.name_kanji is None and "name_kanji" in self.model_fields_set:
            _dict['name_kanji'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "images": CharacterImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "name": obj.get("name"),
            "name_kanji": obj.get("name_kanji"),
            "nicknames": obj.get("nicknames"),
            "favorites": obj.get("favorites"),
            "about": obj.get("about"),
            "anime": [CharacterAnimeDataInner.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [CharacterFullMangaInner.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None,
            "voices": [CharacterFullVoicesInner.from_dict(_item) for _item in obj["voices"]] if obj.get("voices") is not None else None
        })
        return _obj

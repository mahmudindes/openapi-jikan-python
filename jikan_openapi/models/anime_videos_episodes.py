...
class AnimeVideosEpisodes(BaseModel):
    """
    Anime Videos Episodes Resource
    """ # noqa: E501
    pagination: Optional[PaginationPagination] = None
    data: Optional[List[AnimeVideosEpisodesAllOfData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AnimeVideosEpisodesAllOfData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

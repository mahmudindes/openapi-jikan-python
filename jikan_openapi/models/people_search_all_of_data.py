...
class PeopleSearchAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mal_id", "url", "website_url", "images", "name", "given_name", "family_name", "alternate_names", "birthday", "favorites", "about"]

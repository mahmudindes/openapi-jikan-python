...
class GetTopReviews200ResponseDataAllOfDataInnerAnyOf(BaseModel):
    """
    GetTopReviews200ResponseDataAllOfDataInnerAnyOf
    """ # noqa: E501
    mal_id: Optional[StrictInt] = Field(default=None, description="MyAnimeList ID")
    url: Optional[StrictStr] = Field(default=None, description="MyAnimeList review URL")
    type: Optional[StrictStr] = Field(default=None, description="Entry type")
    reactions: Optional[MangaReviewReactions] = None
    var_date: Optional[StrictStr] = Field(default=None, description="Review created date ISO8601", alias="date")
    review: Optional[StrictStr] = Field(default=None, description="Review content")
    score: Optional[StrictInt] = Field(default=None, description="Number of user votes on the Review")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Review tags")
    is_spoiler: Optional[StrictBool] = Field(default=None, description="The review contains spoiler")
    is_preliminary: Optional[StrictBool] = Field(default=None, description="The review was made before the entry was completed")
    episodes_watched: Optional[StrictInt] = Field(default=None, description="Number of episodes watched")
    user: Optional[UserMeta] = None
    anime: Optional[AnimeMeta] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "type", "reactions", "date", "review", "score", "tags", "is_spoiler", "is_preliminary", "episodes_watched", "user", "anime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "type": obj.get("type"),
            "reactions": MangaReviewReactions.from_dict(obj["reactions"]) if obj.get("reactions") is not None else None,
            "date": obj.get("date"),
            "review": obj.get("review"),
            "score": obj.get("score"),
            "tags": obj.get("tags"),
            "is_spoiler": obj.get("is_spoiler"),
            "is_preliminary": obj.get("is_preliminary"),
            "episodes_watched": obj.get("episodes_watched"),
            "user": UserMeta.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "anime": AnimeMeta.from_dict(obj["anime"]) if obj.get("anime") is not None else None
        })
        return _obj

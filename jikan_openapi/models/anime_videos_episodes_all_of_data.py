...
class AnimeVideosEpisodesAllOfData(BaseModel):
    """
    AnimeVideosEpisodesAllOfData
    """ # noqa: E501
    mal_id: Optional[StrictInt] = Field(default=None, description="MyAnimeList ID or Episode Number")
    title: Optional[StrictStr] = Field(default=None, description="Episode Title")
    episode: Optional[StrictStr] = Field(default=None, description="Episode Subtitle")
    url: Optional[StrictStr] = Field(default=None, description="Episode Page URL")
    images: Optional[CommonImages] = None
    __properties: ClassVar[List[str]] = ["mal_id", "title", "episode", "url", "images"]

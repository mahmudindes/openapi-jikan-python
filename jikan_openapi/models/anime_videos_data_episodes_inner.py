...
class AnimeVideosDataEpisodesInner(BaseModel):
    """
    ...
    episode: Optional[StrictStr] = Field(default=None, description="Episode")
    images: Optional[CommonImages] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "title", "episode", "images"]

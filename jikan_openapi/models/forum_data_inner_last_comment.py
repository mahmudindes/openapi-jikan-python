...
class ForumDataInnerLastComment(BaseModel):
    """
    Last comment details
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="Last comment URL")
    ...
    var_date: Optional[StrictStr] = Field(default=None, description="Last comment date posted ISO8601", alias="date")
    __properties: ClassVar[List[str]] = ["url", "author_username", "author_url", "date"]

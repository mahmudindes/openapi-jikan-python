...
class TrailerImagesImages(BaseModel):
    """
    TrailerImagesImages
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="Default Image Size URL (120x90)")
    small_image_url: Optional[StrictStr] = Field(default=None, description="Small Image Size URL (640x480)")
    medium_image_url: Optional[StrictStr] = Field(default=None, description="Medium Image Size URL (320x180)")
    large_image_url: Optional[StrictStr] = Field(default=None, description="Large Image Size URL (480x360)")
    maximum_image_url: Optional[StrictStr] = Field(default=None, description="Maximum Image Size URL (1280x720)")
    __properties: ClassVar[List[str]] = ["image_url", "small_image_url", "medium_image_url", "large_image_url", "maximum_image_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if small_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.small_image_url is None and "small_image_url" in self.model_fields_set:
            _dict['small_image_url'] = None

        # set to None if medium_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.medium_image_url is None and "medium_image_url" in self.model_fields_set:
            _dict['medium_image_url'] = None

        # set to None if large_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.large_image_url is None and "large_image_url" in self.model_fields_set:
            _dict['large_image_url'] = None

        # set to None if maximum_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_image_url is None and "maximum_image_url" in self.model_fields_set:
            _dict['maximum_image_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "small_image_url": obj.get("small_image_url"),
            "medium_image_url": obj.get("medium_image_url"),
            "large_image_url": obj.get("large_image_url"),
            "maximum_image_url": obj.get("maximum_image_url")
        })
        return _obj

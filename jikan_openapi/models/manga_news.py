...
class MangaNews(BaseModel):
    """
    Manga News Resource
    """ # noqa: E501
    pagination: Optional[PaginationPagination] = None
    data: Optional[List[NewsDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [NewsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

...
class GetTopReviews200ResponseDataAllOfDataInnerAnyOf1(BaseModel):
    """
    ...
    manga: Optional[MangaMeta] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "type", "reactions", "date", "review", "score", "tags", "is_spoiler", "is_preliminary", "user", "manga"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manga": MangaMeta.from_dict(obj["manga"]) if obj.get("manga") is not None else None
        })
        return _obj

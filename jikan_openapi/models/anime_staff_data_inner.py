...
class AnimeStaffDataInner(BaseModel):
    """
    AnimeStaffDataInner
    """ # noqa: E501
    person: Optional[AnimeStaffDataInnerPerson] = None
    positions: Optional[List[StrictStr]] = Field(default=None, description="Staff Positions")
    __properties: ClassVar[List[str]] = ["person", "positions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "person": AnimeStaffDataInnerPerson.from_dict(obj["person"]) if obj.get("person") is not None else None,

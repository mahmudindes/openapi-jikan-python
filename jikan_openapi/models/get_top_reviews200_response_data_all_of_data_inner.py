...
GETTOPREVIEWS200RESPONSEDATAALLOFDATAINNER_ANY_OF_SCHEMAS = ["GetTopReviews200ResponseDataAllOfDataInnerAnyOf", "GetTopReviews200ResponseDataAllOfDataInnerAnyOf1"]

class GetTopReviews200ResponseDataAllOfDataInner(BaseModel):
    """
    GetTopReviews200ResponseDataAllOfDataInner
    """

    # data type: GetTopReviews200ResponseDataAllOfDataInnerAnyOf
    anyof_schema_1_validator: Optional[GetTopReviews200ResponseDataAllOfDataInnerAnyOf] = None
    # data type: GetTopReviews200ResponseDataAllOfDataInnerAnyOf1
    anyof_schema_2_validator: Optional[GetTopReviews200ResponseDataAllOfDataInnerAnyOf1] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GetTopReviews200ResponseDataAllOfDataInnerAnyOf, GetTopReviews200ResponseDataAllOfDataInnerAnyOf1]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = Field(default=Literal["GetTopReviews200ResponseDataAllOfDataInnerAnyOf", "GetTopReviews200ResponseDataAllOfDataInnerAnyOf1"])
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GetTopReviews200ResponseDataAllOfDataInner.model_construct()
        error_messages = []
        # validate data type: GetTopReviews200ResponseDataAllOfDataInnerAnyOf
        if not isinstance(v, GetTopReviews200ResponseDataAllOfDataInnerAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GetTopReviews200ResponseDataAllOfDataInnerAnyOf`")
        else:
            return v

        # validate data type: GetTopReviews200ResponseDataAllOfDataInnerAnyOf1
        if not isinstance(v, GetTopReviews200ResponseDataAllOfDataInnerAnyOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GetTopReviews200ResponseDataAllOfDataInnerAnyOf1`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetTopReviews200ResponseDataAllOfDataInner with anyOf schemas: GetTopReviews200ResponseDataAllOfDataInnerAnyOf, GetTopReviews200ResponseDataAllOfDataInnerAnyOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[GetTopReviews200ResponseDataAllOfDataInnerAnyOf] = None
        try:
            instance.actual_instance = GetTopReviews200ResponseDataAllOfDataInnerAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[GetTopReviews200ResponseDataAllOfDataInnerAnyOf1] = None
        try:
            instance.actual_instance = GetTopReviews200ResponseDataAllOfDataInnerAnyOf1.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetTopReviews200ResponseDataAllOfDataInner with anyOf schemas: GetTopReviews200ResponseDataAllOfDataInnerAnyOf, GetTopReviews200ResponseDataAllOfDataInnerAnyOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GetTopReviews200ResponseDataAllOfDataInnerAnyOf, GetTopReviews200ResponseDataAllOfDataInnerAnyOf1]]:

...
class Trailer(BaseModel):
    ...
    Youtube Details
    """ # noqa: E501
    youtube_id: Optional[StrictStr] = Field(default=None, description="YouTube ID")
    url: Optional[StrictStr] = Field(default=None, description="YouTube URL")
    embed_url: Optional[StrictStr] = Field(default=None, description="Parsed Embed URL")
    images: Optional[TrailerImagesImages] = None
    __properties: ClassVar[List[str]] = ["youtube_id", "url", "embed_url", "images"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": TrailerImagesImages.from_dict(obj["images"]) if obj.get("images") is not None else None
        })
        return _obj

...
class PersonFullVoicesInner(BaseModel):
    """
    PersonFullVoicesInner
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="Person's Character's role in the anime")
    anime: Optional[AnimeMeta] = None
    character: Optional[CharacterMeta] = None
    __properties: ClassVar[List[str]] = ["role", "anime", "character"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "character": CharacterMeta.from_dict(obj["character"]) if obj.get("character") is not None else None
        })
        return _obj

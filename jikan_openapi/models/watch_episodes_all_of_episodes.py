...
class WatchEpisodesAllOfEpisodes(BaseModel):
    """
    WatchEpisodesAllOfEpisodes
    """ # noqa: E501
    mal_id: Optional[StrictStr] = Field(default=None, description="MyAnimeList ID")
    ...
    premium: Optional[StrictBool] = Field(default=None, description="For MyAnimeList Premium Users")
    __properties: ClassVar[List[str]] = ["mal_id", "url", "title", "premium"]

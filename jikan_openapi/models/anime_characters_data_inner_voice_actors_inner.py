...
class AnimeCharactersDataInnerVoiceActorsInner(BaseModel):
    """
    AnimeCharactersDataInnerVoiceActorsInner
    """ # noqa: E501
    person: Optional[AnimeCharactersDataInnerVoiceActorsInnerPerson] = None
    language: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["person", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "person": AnimeCharactersDataInnerVoiceActorsInnerPerson.from_dict(obj["person"]) if obj.get("person") is not None else None,

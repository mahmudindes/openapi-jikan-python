...
class CharacterPicturesDataInner(BaseModel):
    """
    CharacterPicturesDataInner
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="Default JPG Image Size URL")
    large_image_url: Optional[StrictStr] = Field(default=None, description="Large JPG Image Size URL")
    __properties: ClassVar[List[str]] = ["image_url", "large_image_url"]

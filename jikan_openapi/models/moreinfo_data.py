...
class MoreinfoData(BaseModel):
    """
    MoreinfoData
    """ # noqa: E501
    moreinfo: Optional[StrictStr] = Field(default=None, description="Additional information on the entry")
    __properties: ClassVar[List[str]] = ["moreinfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if moreinfo (nullable) is None
        # and model_fields_set contains the field
        if self.moreinfo is None and "moreinfo" in self.model_fields_set:
            _dict['moreinfo'] = None

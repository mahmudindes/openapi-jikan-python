...
class UserFriendsAllOfData(BaseModel):
    """
    UserFriendsAllOfData
    """ # noqa: E501
    user: Optional[UserMeta] = None
    last_online: Optional[StrictStr] = Field(default=None, description="Last Online Date ISO8601 format")
    friends_since: Optional[StrictStr] = Field(default=None, description="Friends Since Date ISO8601 format")
    __properties: ClassVar[List[str]] = ["user", "last_online", "friends_since"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "friends_since": obj.get("friends_since")
        })
        return _obj

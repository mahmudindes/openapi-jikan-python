...
class AnimeVideosData(BaseModel):
    """
    AnimeVideosData
    """ # noqa: E501
    promo: Optional[List[AnimeVideosDataPromoInner]] = None
    episodes: Optional[List[AnimeVideosDataEpisodesInner]] = None
    music_videos: Optional[List[AnimeVideosDataMusicVideosInner]] = None
    __properties: ClassVar[List[str]] = ["promo", "episodes", "music_videos"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in promo (list)
        _items = []
        if self.promo:
            for _item in self.promo:
                if _item:
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in music_videos (list)
        _items = []
        if self.music_videos:
            for _item in self.music_videos:
                if _item:
                    _items.append(_item.to_dict())
            _dict['music_videos'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "promo": [AnimeVideosDataPromoInner.from_dict(_item) for _item in obj["promo"]] if obj.get("promo") is not None else None,
            "episodes": [AnimeVideosDataEpisodesInner.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "music_videos": [AnimeVideosDataMusicVideosInner.from_dict(_item) for _item in obj["music_videos"]] if obj.get("music_videos") is not None else None
        })
        return _obj

...
class Daterange(BaseModel):
    ...
    Date range
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, description="Date ISO8601", alias="from")
    to: Optional[StrictStr] = Field(default=None, description="Date ISO8601")
    prop: Optional[DaterangeProp] = None
    __properties: ClassVar[List[str]] = ["from", "to", "prop"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of prop
        if self.prop:
            _dict['prop'] = self.prop.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": obj.get("from"),
            "to": obj.get("to"),
            "prop": DaterangeProp.from_dict(obj["prop"]) if obj.get("prop") is not None else None
        })
        return _obj

...
class UserProfileFullStatisticsAnime(BaseModel):
    """
    Anime Statistics
    """ # noqa: E501
    days_watched: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of days spent watching Anime")
    mean_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Mean Score")
    watching: Optional[StrictInt] = Field(default=None, description="Anime Watching")
    completed: Optional[StrictInt] = Field(default=None, description="Anime Completed")
    on_hold: Optional[StrictInt] = Field(default=None, description="Anime On-Hold")
    dropped: Optional[StrictInt] = Field(default=None, description="Anime Dropped")
    plan_to_watch: Optional[StrictInt] = Field(default=None, description="Anime Planned to Watch")
    total_entries: Optional[StrictInt] = Field(default=None, description="Total Anime entries on User list")
    rewatched: Optional[StrictInt] = Field(default=None, description="Anime re-watched")
    episodes_watched: Optional[StrictInt] = Field(default=None, description="Number of Anime Episodes Watched")
    __properties: ClassVar[List[str]] = ["days_watched", "mean_score", "watching", "completed", "on_hold", "dropped", "plan_to_watch", "total_entries", "rewatched", "episodes_watched"]

...
class PeopleSearch(BaseModel):
    ...
    People Search
    """ # noqa: E501
    pagination: Optional[PaginationPlusPagination] = None
    data: Optional[List[PeopleSearchAllOfData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagination": PaginationPlusPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "data": [PeopleSearchAllOfData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

...
class PersonFull(BaseModel):
    ...
    website_url: Optional[StrictStr] = Field(default=None, description="Person's website URL")
    images: Optional[PeopleImages] = None
    name: Optional[StrictStr] = Field(default=None, description="Name")
    given_name: Optional[StrictStr] = Field(default=None, description="Given Name")
    family_name: Optional[StrictStr] = Field(default=None, description="Family Name")
    alternate_names: Optional[List[StrictStr]] = Field(default=None, description="Other Names")
    ...
    about: Optional[StrictStr] = Field(default=None, description="Biography")
    anime: Optional[List[PersonAnimeDataInner]] = None
    manga: Optional[List[PersonFullMangaInner]] = None
    voices: Optional[List[PersonFullVoicesInner]] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "website_url", "images", "name", "given_name", "family_name", "alternate_names", "birthday", "favorites", "about", "anime", "manga", "voices"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in anime (list)
        _items = []
        if self.anime:
            for _item in self.anime:
                if _item:
                    _items.append(_item.to_dict())
            _dict['anime'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in manga (list)
        _items = []
        if self.manga:
            for _item in self.manga:
                if _item:
                    _items.append(_item.to_dict())
            _dict['manga'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": PeopleImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "name": obj.get("name"),
            ...
            "about": obj.get("about"),
            "anime": [PersonAnimeDataInner.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [PersonFullMangaInner.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None,
            "voices": [PersonFullVoicesInner.from_dict(_item) for _item in obj["voices"]] if obj.get("voices") is not None else None
        })
        return _obj

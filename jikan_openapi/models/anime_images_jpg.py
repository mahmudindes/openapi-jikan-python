...
class AnimeImagesJpg(BaseModel):
    """
    Available images in JPG
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="Image URL JPG")
    small_image_url: Optional[StrictStr] = Field(default=None, description="Small Image URL JPG")
    large_image_url: Optional[StrictStr] = Field(default=None, description="Image URL JPG")

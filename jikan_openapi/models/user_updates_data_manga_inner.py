...
class UserUpdatesDataMangaInner(BaseModel):
    """
    UserUpdatesDataMangaInner
    """ # noqa: E501
    entry: Optional[MangaMeta] = None
    score: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    chapters_read: Optional[StrictInt] = None
    chapters_total: Optional[StrictInt] = None
    volumes_read: Optional[StrictInt] = None
    volumes_total: Optional[StrictInt] = None
    var_date: Optional[StrictStr] = Field(default=None, description="ISO8601 format", alias="date")
    __properties: ClassVar[List[str]] = ["entry", "score", "status", "chapters_read", "chapters_total", "volumes_read", "volumes_total", "date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if chapters_read (nullable) is None
        # and model_fields_set contains the field
        if self.chapters_read is None and "chapters_read" in self.model_fields_set:
            _dict['chapters_read'] = None

        # set to None if chapters_total (nullable) is None
        # and model_fields_set contains the field
        if self.chapters_total is None and "chapters_total" in self.model_fields_set:
            _dict['chapters_total'] = None

        # set to None if volumes_read (nullable) is None
        # and model_fields_set contains the field
        if self.volumes_read is None and "volumes_read" in self.model_fields_set:
            _dict['volumes_read'] = None

        # set to None if volumes_total (nullable) is None
        # and model_fields_set contains the field
        if self.volumes_total is None and "volumes_total" in self.model_fields_set:
            _dict['volumes_total'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": MangaMeta.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
            "score": obj.get("score"),
            "status": obj.get("status"),
            "chapters_read": obj.get("chapters_read"),
            "chapters_total": obj.get("chapters_total"),
            "volumes_read": obj.get("volumes_read"),
            "volumes_total": obj.get("volumes_total"),
            "date": obj.get("date")
        })
        return _obj

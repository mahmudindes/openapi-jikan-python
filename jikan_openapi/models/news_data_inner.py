...
class NewsDataInner(BaseModel):
    ...
    forum_url: Optional[StrictStr] = Field(default=None, description="Forum topic URL")
    images: Optional[CommonImages] = None
    comments: Optional[StrictInt] = Field(default=None, description="Comment count")
    excerpt: Optional[StrictStr] = Field(default=None, description="Excerpt")
    __properties: ClassVar[List[str]] = ["mal_id", "url", "title", "date", "author_username", "author_url", "forum_url", "images", "comments", "excerpt"]

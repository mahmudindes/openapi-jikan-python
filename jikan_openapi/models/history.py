...
class History(BaseModel):
    ...
    """ # noqa: E501
    entry: Optional[MalUrl] = None
    increment: Optional[StrictInt] = Field(default=None, description="Number of episodes/chapters watched/read")
    var_date: Optional[StrictStr] = Field(default=None, description="Date ISO8601", alias="date")
    __properties: ClassVar[List[str]] = ["entry", "increment", "date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": MalUrl.from_dict(obj["entry"]) if obj.get("entry") is not None else None,

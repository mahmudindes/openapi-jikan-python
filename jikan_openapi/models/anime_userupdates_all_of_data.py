...
class AnimeUserupdatesAllOfData(BaseModel):
    """
    AnimeUserupdatesAllOfData
    """ # noqa: E501
    user: Optional[UserMeta] = None
    score: Optional[StrictInt] = Field(default=None, description="User Score")
    status: Optional[StrictStr] = Field(default=None, description="User list status")
    episodes_seen: Optional[StrictInt] = Field(default=None, description="Number of episodes seen")
    episodes_total: Optional[StrictInt] = Field(default=None, description="Total number of episodes")
    var_date: Optional[StrictStr] = Field(default=None, description="Last updated date ISO8601", alias="date")
    __properties: ClassVar[List[str]] = ["user", "score", "status", "episodes_seen", "episodes_total", "date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if episodes_seen (nullable) is None
        # and model_fields_set contains the field
        if self.episodes_seen is None and "episodes_seen" in self.model_fields_set:
            _dict['episodes_seen'] = None

        # set to None if episodes_total (nullable) is None
        # and model_fields_set contains the field
        if self.episodes_total is None and "episodes_total" in self.model_fields_set:
            _dict['episodes_total'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "episodes_seen": obj.get("episodes_seen"),
            "episodes_total": obj.get("episodes_total"),
            "date": obj.get("date")
        })
        return _obj

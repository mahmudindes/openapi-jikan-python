...
class MangaStatisticsData(BaseModel):
    """
    MangaStatisticsData
    """ # noqa: E501
    reading: Optional[StrictInt] = Field(default=None, description="Number of users reading the resource")
    ...
    plan_to_read: Optional[StrictInt] = Field(default=None, description="Number of users who have planned to read the resource")
    ...
    __properties: ClassVar[List[str]] = ["reading", "completed", "on_hold", "dropped", "plan_to_read", "total", "scores"]

...
class UsersTempDataInnerImages(BaseModel):
    """
    Images
    """ # noqa: E501
    jpg: Optional[UsersTempDataInnerImagesJpg] = None
    webp: Optional[UsersTempDataInnerImagesWebp] = None
    __properties: ClassVar[List[str]] = ["jpg", "webp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of jpg
        if self.jpg:
            _dict['jpg'] = self.jpg.to_dict()
        # override the default output from pydantic by calling `to_dict()` of webp
        if self.webp:
            _dict['webp'] = self.webp.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jpg": UsersTempDataInnerImagesJpg.from_dict(obj["jpg"]) if obj.get("jpg") is not None else None,
            "webp": UsersTempDataInnerImagesWebp.from_dict(obj["webp"]) if obj.get("webp") is not None else None
        })
        return _obj

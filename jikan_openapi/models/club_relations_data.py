...
class ClubRelationsData(BaseModel):
    """
    ClubRelationsData
    """ # noqa: E501
    anime: Optional[List[MalUrl]] = None
    manga: Optional[List[MalUrl]] = None
    characters: Optional[List[MalUrl]] = None
    __properties: ClassVar[List[str]] = ["anime", "manga", "characters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anime": [MalUrl.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [MalUrl.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None,
            "characters": [MalUrl.from_dict(_item) for _item in obj["characters"]] if obj.get("characters") is not None else None
        })
        return _obj

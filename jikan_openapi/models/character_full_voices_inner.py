...
class CharacterFullVoicesInner(BaseModel):
    """
    CharacterFullVoicesInner
    """ # noqa: E501
    language: Optional[StrictStr] = Field(default=None, description="Character's Role")
    person: Optional[PersonMeta] = None
    __properties: ClassVar[List[str]] = ["language", "person"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "person": PersonMeta.from_dict(obj["person"]) if obj.get("person") is not None else None
        })
        return _obj

...
class UserFavorites(BaseModel):
    ...
    UserFavorites
    """ # noqa: E501
    anime: Optional[List[UserFavoritesAnimeInner]] = Field(default=None, description="Favorite Anime")
    manga: Optional[List[UserFavoritesMangaInner]] = Field(default=None, description="Favorite Manga")
    characters: Optional[List[UserFavoritesCharactersInner]] = Field(default=None, description="Favorite Characters")
    people: Optional[List[CharacterMeta]] = Field(default=None, description="Favorite People")
    __properties: ClassVar[List[str]] = ["anime", "manga", "characters", "people"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anime": [UserFavoritesAnimeInner.from_dict(_item) for _item in obj["anime"]] if obj.get("anime") is not None else None,
            "manga": [UserFavoritesMangaInner.from_dict(_item) for _item in obj["manga"]] if obj.get("manga") is not None else None,
            "characters": [UserFavoritesCharactersInner.from_dict(_item) for _item in obj["characters"]] if obj.get("characters") is not None else None,
            "people": [CharacterMeta.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None
        })
        return _obj

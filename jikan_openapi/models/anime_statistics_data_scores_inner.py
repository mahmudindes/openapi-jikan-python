...
class AnimeStatisticsDataScoresInner(BaseModel):
    """
    AnimeStatisticsDataScoresInner
    """ # noqa: E501
    score: Optional[StrictInt] = Field(default=None, description="Scoring value")
    votes: Optional[StrictInt] = Field(default=None, description="Number of votes for this score")
    percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentage of votes for this score")
    __properties: ClassVar[List[str]] = ["score", "votes", "percentage"]

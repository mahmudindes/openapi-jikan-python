...
class WatchEpisodesAllOfData(BaseModel):
    """
    WatchEpisodesAllOfData
    """ # noqa: E501
    entry: Optional[AnimeMeta] = None
    episodes: Optional[List[WatchEpisodesAllOfEpisodes]] = Field(default=None, description="Recent Episodes (max 2 listed)")
    region_locked: Optional[StrictBool] = Field(default=None, description="Region Locked Episode")
    __properties: ClassVar[List[str]] = ["entry", "episodes", "region_locked"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "episodes": [WatchEpisodesAllOfEpisodes.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "region_locked": obj.get("region_locked")
        })
        return _obj

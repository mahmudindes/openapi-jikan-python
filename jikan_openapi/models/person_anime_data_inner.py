...
class PersonAnimeDataInner(BaseModel):
    """
    PersonAnimeDataInner
    """ # noqa: E501
    position: Optional[StrictStr] = Field(default=None, description="Person's position")
    anime: Optional[AnimeMeta] = None
    __properties: ClassVar[List[str]] = ["position", "anime"]

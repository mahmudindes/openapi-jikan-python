...
class Club(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Club name")
    url: Optional[StrictStr] = Field(default=None, description="Club URL")
    images: Optional[CommonImages] = None
    members: Optional[StrictInt] = Field(default=None, description="Number of club members")
    category: Optional[StrictStr] = Field(default=None, description="Club Category")
    created: Optional[StrictStr] = Field(default=None, description="Date Created ISO8601")
    access: Optional[StrictStr] = Field(default=None, description="Club access")
    __properties: ClassVar[List[str]] = ["mal_id", "name", "url", "images", "members", "category", "created", "access"]
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['actors & artists', 'anime', 'characters', 'cities & neighborhoods', 'companies', 'conventions', 'games', 'japan', 'manga', 'music', 'others', 'schools']):
            raise ValueError("must be one of enum values ('actors & artists', 'anime', 'characters', 'cities & neighborhoods', 'companies', 'conventions', 'games', 'japan', 'manga', 'music', 'others', 'schools')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "url": obj.get("url"),
            "images": CommonImages.from_dict(obj["images"]) if obj.get("images") is not None else None,

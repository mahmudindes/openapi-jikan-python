...
class UserUpdatesDataAnimeInner(BaseModel):
    """
    ...
    episodes_seen: Optional[StrictInt] = None
    episodes_total: Optional[StrictInt] = None
    var_date: Optional[StrictStr] = Field(default=None, description="ISO8601 format", alias="date")
    __properties: ClassVar[List[str]] = ["entry", "score", "status", "episodes_seen", "episodes_total", "date"]

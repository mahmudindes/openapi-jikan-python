...
class AnimeImagesWebp(BaseModel):
    """
    Available images in WEBP
    """ # noqa: E501
    image_url: Optional[StrictStr] = Field(default=None, description="Image URL WEBP")
    small_image_url: Optional[StrictStr] = Field(default=None, description="Small Image URL WEBP")
    large_image_url: Optional[StrictStr] = Field(default=None, description="Image URL WEBP")
    __properties: ClassVar[List[str]] = ["image_url", "small_image_url", "large_image_url"]

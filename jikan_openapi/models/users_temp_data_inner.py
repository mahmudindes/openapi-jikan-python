...
class UsersTempDataInner(BaseModel):
    """
    UsersTempDataInner
    """ # noqa: E501
    ...
    images: Optional[UsersTempDataInnerImages] = None
    ...
    anime_stats: Optional[UsersTempDataInnerAnimeStats] = None
    manga_stats: Optional[UsersTempDataInnerMangaStats] = None
    favorites: Optional[UsersTempDataInnerFavorites] = None
    about: Optional[StrictStr] = Field(default=None, description="User About. NOTE: About information is customizable by users through BBCode on MyAnimeList. This means users can add multimedia content, different text sizes, etc. Due to this freeform, Jikan returns parsed HTML. Validate on your end!")
    __properties: ClassVar[List[str]] = ["mal_id", "username", "url", "images", "last_online", "gender", "birthday", "location", "joined", "anime_stats", "manga_stats", "favorites", "about"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of anime_stats
        if self.anime_stats:
            _dict['anime_stats'] = self.anime_stats.to_dict()
        # override the default output from pydantic by calling `to_dict()` of manga_stats
        if self.manga_stats:
            _dict['manga_stats'] = self.manga_stats.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "images": UsersTempDataInnerImages.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "last_online": obj.get("last_online"),
            "gender": obj.get("gender"),
            "birthday": obj.get("birthday"),
            "location": obj.get("location"),
            "joined": obj.get("joined"),
            "anime_stats": UsersTempDataInnerAnimeStats.from_dict(obj["anime_stats"]) if obj.get("anime_stats") is not None else None,
            "manga_stats": UsersTempDataInnerMangaStats.from_dict(obj["manga_stats"]) if obj.get("manga_stats") is not None else None,
            "favorites": UsersTempDataInnerFavorites.from_dict(obj["favorites"]) if obj.get("favorites") is not None else None,
            "about": obj.get("about")
        })
        return _obj

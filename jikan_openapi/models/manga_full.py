...
class MangaFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["mal_id", "url", "images", "approved", "titles", "title", "title_english", "title_japanese", "title_synonyms", "type", "chapters", "volumes", "status", "publishing", "published", "score", "scored_by", "rank", "popularity", "members", "favorites", "synopsis", "background", "authors", "serializations", "genres", "explicit_genres", "themes", "demographics", "relations", "external"]

...
class AnimeEpisodesAllOfData(BaseModel):
    """
    AnimeEpisodesAllOfData
    """ # noqa: E501
    mal_id: Optional[StrictInt] = Field(default=None, description="MyAnimeList ID")
    url: Optional[StrictStr] = Field(default=None, description="MyAnimeList URL. This is the URL of the episode's video. If there is no video url, this will be null.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if title_romanji (nullable) is None
        # and model_fields_set contains the field

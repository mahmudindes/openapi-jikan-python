...
class MangaReviewReactions(BaseModel):
    """
    User reaction count on the review
    """ # noqa: E501
    overall: Optional[StrictInt] = Field(default=None, description="Overall reaction count")
    nice: Optional[StrictInt] = Field(default=None, description="Nice reaction count")
    love_it: Optional[StrictInt] = Field(default=None, description="Love it reaction count")
    funny: Optional[StrictInt] = Field(default=None, description="Funny reaction count")
    confusing: Optional[StrictInt] = Field(default=None, description="Confusing reaction count")
    informative: Optional[StrictInt] = Field(default=None, description="Informative reaction count")
    well_written: Optional[StrictInt] = Field(default=None, description="Well written reaction count")
    creative: Optional[StrictInt] = Field(default=None, description="Creative reaction count")
    __properties: ClassVar[List[str]] = ["overall", "nice", "love_it", "funny", "confusing", "informative", "well_written", "creative"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nice": obj.get("nice"),
            "love_it": obj.get("love_it"),
            "funny": obj.get("funny"),
            "confusing": obj.get("confusing"),
            "informative": obj.get("informative"),
            "well_written": obj.get("well_written"),

...
class ForumDataInner(BaseModel):
    """
    ForumDataInner
    """ # noqa: E501
    ...
    var_date: Optional[StrictStr] = Field(default=None, description="Post Date ISO8601", alias="date")
    author_username: Optional[StrictStr] = Field(default=None, description="Author MyAnimeList Username")
    author_url: Optional[StrictStr] = Field(default=None, description="Author Profile URL")
    comments: Optional[StrictInt] = Field(default=None, description="Comment count")
    last_comment: Optional[ForumDataInnerLastComment] = None
    __properties: ClassVar[List[str]] = ["mal_id", "url", "title", "date", "author_username", "author_url", "comments", "last_comment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_comment
        if self.last_comment:
            _dict['last_comment'] = self.last_comment.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_comment": ForumDataInnerLastComment.from_dict(obj["last_comment"]) if obj.get("last_comment") is not None else None
        })
        return _obj
